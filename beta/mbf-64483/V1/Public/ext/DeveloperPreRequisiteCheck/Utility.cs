...
namespace DeveloperPreRequisiteCheck
{
    ...
    public static class Utility
    {
        ...
        /// <summary>
        /// Sample path for configuring WIX Path
        /// </summary>
        public const string SAMPLE_WIXPATH = @"C:\Program Files\Windows Installer XML v3\bin";

        /// <summary>
        /// Sample path for configuring SandCastle Path
        /// </summary>
        public const string SAMPLE_SANDCASTLEPATH = @"C:\Program Files\Sandcastle";

        /// <summary>
        /// Sample path for configuring HHC Path
        /// </summary>
        public const string SAMPLE_HHCPATH = @"C:\Program Files\HTML Help Workshop";
