// -------------------------------------------------------------------------------------
// <copyright file="VirtualList.cs" company="Microsoft">
//  Copyright (c) Microsoft Corporation.  All rights reserved.
// </copyright>
// <summary>
// This is a IList<T> implementation which is basically built to point to objects in 
// another list without holding a strong reference to that object, but by keeping the 
// reference to the list and index of the item to point. So that if we are pointing to 
// a virtual list based on weak references, this list will not hold a strong reference 
// to an item in the target list.
// NOTE: Modifying the source list after populating this virtual list might result in 
// corrupt data as the index of the item in the source list will change.
// </summary>
// -------------------------------------------------------------------------------------
