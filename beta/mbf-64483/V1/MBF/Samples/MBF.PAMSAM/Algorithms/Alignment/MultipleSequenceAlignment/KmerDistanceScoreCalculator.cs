...
namespace MBF.Algorithms.Alignment.MultipleSequenceAlignment
{
    ...
    public sealed class KmerDistanceScoreCalculator
    {
        ...
        /// </summary>
        public KmerDistanceScoreCalculator(int kmerLength, MoleculeType moleculeType)
            : this(kmerLength, moleculeType, DistanceFunctionTypes.EuclideanDistance)
        {
        }
