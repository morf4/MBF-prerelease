...
namespace MBF.TestAutomation.Algorithms.Alignment
{
    ...
    /// </summary>
    [TestFixture]
    public class PairwiseOverlapP2TestCases
    {
        ...
        /// </summary>
        static PairwiseOverlapP2TestCases()
        {
        ...
        static void ValidatePairwiseOverlapAlignment(string nodeName,
        ...
        static void ValidatePairwiseOverlapAlignment(string nodeName, bool isTextFile,
            ...
            AlignmentType alignType, SimilarityMatrixParameters similarityMatrixParam)
        {
            ...
            ApplicationLog.WriteLine(string.Format(null,
                "PairwiseOverlapAligner P2 : First sequence used is '{0}'.", aInput.ToString()));
            ApplicationLog.WriteLine(string.Format(null,
                "PairwiseOverlapAligner P2 : Second sequence used is '{0}'.", bInput.ToString()));
        ...
        /// <param name="additionalParameter">parameter based on which certain validations are done.</param>
        /// <param name="alignType">Is the Align type Simple or Align with Gap Extension cost?</param>
        static void InValidatePairwiseOverlapAlignmentWithInvalidSequence(string nodeName,
        ...
        /// <param name="additionalParameter">parameter based on which certain validations are done.</param>
        /// <param name="alignType">Is the Align type Simple or Align with Gap Extension cost?</param>
        static void InValidatePairwiseOverlapAlignmentWithInvalidSimilarityMatrix(string nodeName,
            ...
            AlignmentType alignType)
        {
            ...
            if (isTextFile)
            {
                ...
                GetSequenceWithCaseType(inputSequence1.ToString(),
                    inputSequence2.ToString(), alphabet, SequenceCaseType.LowerCase, out aInput, out bInput);
            }
            else
            {
        ...
        static void GetSequenceWithCaseType(string firstSequenceString,
