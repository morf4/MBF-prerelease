...
namespace MBF.TestAutomation.Algorithms.Alignment
{
    ...
    public class NUCmerP2TestCases
    {
        ...
        static void ValidateNUCmerEmptyAlignGeneralTestCases(IList<ISequence> sequenceList)
        {
        ...
        static void ValidateNUCmerAlignGeneralTestCases(string nodeName)
        {
            ...
            NUCmer nucmerObj = new NUCmer3();
            mumLength = Utility._xmlUtil.GetTextValue(nodeName, Constants.MUMLengthNode);
            ...
            {
                exThrown = true;
                Assert.IsTrue(exThrown, String.Format("NUCmer P2: {0}", ex.Message));
            }
        }
