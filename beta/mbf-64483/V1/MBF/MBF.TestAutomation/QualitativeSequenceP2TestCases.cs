...
namespace MBF.TestAutomation
{
    ...
    public class QualitativeSequenceP2TestCases
    {
        ...
        public void ValidateReverseOfDnaQualSeq()
        {
            ...
            string reversedSeq = Utility._xmlUtil.GetTextValue(
        ...
        {
            // Get Values from xml node.
            string complementSeq = Utility._xmlUtil.GetTextValue(
        ...
        public void InvalidateContainsSeqItems()
        {
            ...
            result = qualSeq.Contains(invalidScore);
        ...
        public void InvalidateInsertSeqItems()
        {
            ...
            string readOnlyError = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
        ...
        public void InvalidateInsertRangeSeq()
        {
            ...
            string readOnlyError = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.ReadOnlyException);
            string invalidScoreError = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
        ...
        public void InvalidateGetObjectData()
        {
            ...
            string inputSequence = Utility._xmlUtil.GetTextValue(
                 Constants.QualitativeSequenceInsertSeqItemNode,
                 Constants.inputSequenceNode);
            string infoNullError = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
        ...
        public void InvalidateRangeWithInvalidValues()
        {
            ...
            string inputSequence = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.inputSequenceNode);
            string startOutOfRangeException = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.OutOfRangeExceptionNode);
            string lengthOutOfRangeException = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
        ...
        public void InvalidateReplaceMethod()
        {
            ...
            string inputSequence = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.inputSequenceNode);
            string readOnlyException = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.ReadOnlyException);
            string invalidPostionError = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
        ...
        public void InvalidateReplaceRangeMethod()
        {
            ...
            string readOnlyException = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.ReadOnlyException);
            string invalidSeqException = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
        ...
        public void InvalidateQualitativeSeqCtor()
        {
            ...
            string inputSequence = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.inputSequenceNode);
            string QualScoreError = Utility._xmlUtil.GetTextValue(
                Constants.QualitativeSequenceInsertSeqItemNode,
                Constants.NullExceptionError);

            SequenceDecoder decoder = new SequenceDecoder(Encodings.Ncbi2NA);
            ...
            try
            {
                new QualitativeSequence(Alphabets.DNA,
                    FastQFormatType.Sanger, Encodings.IupacNA, encoder,
                    decoder, inputSequence, null);
        ...
        /// </summary>
        static void InValidateQualSequence(string nodeName, string errorMessage,
        ...
        /// </summary>
        static void InValidateQualSequenceGenearlMethods(string nodeName, string errorMessage,
        ...
        /// </summary>
        static void InvalidateFormatTypeConvertion(
        ...
        /// </summary>
        static void ConvertSangerToSolexa()
        {
            string expectedNullErrorMessage = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.NullExceptionError);
            string expectedInvalidScoreError = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.InvalidScoreErrorNode);
            string expectedInvalidQualityScoreError = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
        ...
        /// </summary>
        static void ConvertSangerToIllumina()
        {
            string expectedNullErrorMessage = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.NullExceptionError);
        ...
        /// </summary>
        static void ConvertSolexaToIllumina()
        {
            string expectedNullErrorMessage = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.NullExceptionError);
        ...
        /// </summary>
        static void ConvertIlluminaToSanger()
        {
            string expectedNullErrorMessage = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.NullExceptionError);
        ...
        /// </summary>
        static void ConvertIlluminaToSolexa()
        {
            string expectedNullErrorMessage = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.NullExceptionError);
        ...
        /// </summary>
        static void ConvertSolexaToSanger()
        {
            string expectedNullErrorMessage = Utility._xmlUtil.GetTextValue(
                Constants.FormatTypeConvertionErrosNode,
                Constants.NullExceptionError);
        ...
        /// <param name="parameters">Different Qualitative Sequence parameters.</param>
        /// </summary>
        static void ValidateQualitativeSequenceCtorException(
            string nodeName, QualitativeSequenceParameters parameters)
        {
            // Gets the actual sequence and the alphabet from the Xml
            IAlphabet alphabet = Utility.GetAlphabet(Utility._xmlUtil.GetTextValue(
            ...
            switch (parameters)
            {
                case QualitativeSequenceParameters.EncoderWithByteValue:
                    ...
                    {
                        createdQualitativeSequence = new QualitativeSequence(alphabet, expectedFormatType,
                            Encodings.IupacNA, encoder, decoder, null, byteArray);
                        Assert.Fail();
                    }
                    catch (ArgumentException ex)
                    {
                    ...
                    createdQualitativeSequence = new QualitativeSequence(alphabet, expectedFormatType,
                            Encodings.IupacNA, encoder, decoder, null, null);
                    Assert.IsNullOrEmpty(createdQualitativeSequence.ToString());

                    // Invalidte quality score
                    try
                    {
                        createdQualitativeSequence = new QualitativeSequence(alphabet, expectedFormatType,
                            Encodings.IupacNA, encoder, decoder, "AC", byteArray);
                        Assert.Fail();
                    }
                    catch (ArgumentException ex)
                    {
                    ...
                    {
                        createdQualitativeSequence = new QualitativeSequence(alphabet, expectedFormatType,
                            Encodings.IupacNA, encoder, decoder, inputSequence, invlaidByteArray);
                        Assert.Fail();
                    }
                    catch (ArgumentException ex)
                    {
