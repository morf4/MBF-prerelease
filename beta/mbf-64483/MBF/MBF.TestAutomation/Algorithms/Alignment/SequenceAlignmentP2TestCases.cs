...
namespace MBF.TestAutomation.Algorithms.Alignment
{
    ...
    public class SequenceAlignmentP2TestCases
    {
        ...
        void ValidateGeneralSequenceAlignment(string nodeName,
            OffsetValidation offset, SequenceCaseType caseType, SequenceType type)
        {
            ...
            else
            {
                ...
                string expectedErrorMessage = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        void GetInputSequencesWithSequenceType(string nodeName,
            SequenceType sequenceType, out string firstInputSequence, out string secondInputSequence)
        {
            ...
            switch (sequenceType)
            {
                case SequenceType.SequenceWithSpecialChars:
                    firstInputSequence = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.InvalidSequence1);
                ...
                case SequenceType.SequenceWithSpaces:
                    firstInputSequence = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.SpacesSequence);
                    secondInputSequence = firstInputSequence;
                    break;
                case SequenceType.SequenceWithGap:
                    firstInputSequence = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.GapSequenceNode);
                    secondInputSequence = firstInputSequence;
                    break;
                case SequenceType.Default:
                    firstInputSequence = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.SequenceNode1);
                    secondInputSequence = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.SequenceNode2);
                    break;
            }
        }
        ...
        /// </summary>
        void InValidateSequenceAlignmentGeneralMethods(string nodeName,
            SeqAlignmentMethods methodName)
        {
            ...
            IAlphabet alphabet = Utility.GetAlphabet(_utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.AlphabetNameNode));
            string readOnlyException = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.ReadOnlyExceptionNode);
            string expectedGetObjectDataException = _utilityObj._xmlUtil.GetTextValue(nodeName,
