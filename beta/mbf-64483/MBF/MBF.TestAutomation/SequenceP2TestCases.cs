...
namespace MBF.TestAutomation
{
    ...
    public class SequenceP2TestCases
    {
        ...
        public void ValidateEmptySequence()
        {
            ...
            string genBankFilePath = _utilityObj._xmlUtil.GetTextValue(Constants.EmptyGenBankNodeName,
                Constants.FilePathNode);

            Assert.IsTrue(File.Exists(genBankFilePath));

            // Logs information to the log file
            ApplicationLog.WriteLine(string.Format((IFormatProvider)null, "Sequence P2: The File exist in the Path {0}.",
                genBankFilePath));
        ...
        {
            // Gets the expected sequence from the Xml
            string genBankFilePath = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleGenBankDnaNodeName,
                Constants.FilePathNode);

            string invalidException = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleGenBankDnaNodeName,
        ...
        {
            string expectedErrorMsg = _utilityObj._xmlUtil.GetTextValue(Constants.BasicSeqInfoNode,
        ...
        public void ValidateBasicDerivedSequenceCopyTo()
        {
            ...
            {
                Console.WriteLine(string.Format((IFormatProvider)null, "Successfully caught the exception '{0}'",
                    ex.Message));
                ApplicationLog.WriteLine(string.Format((IFormatProvider)null, "Successfully caught the exception '{0}'",
                    ex.Message));
            }
        }
        ...
        public void InValidateBasicDerivedSeqMethods()
        {
            ...
            catch (NotSupportedException ex)
            {
                ...
                Console.WriteLine(string.Format((IFormatProvider)null, "Sequence P2 : Successfully caught the exception '{0}'",
                    exceptionMessage));
                ApplicationLog.WriteLine(string.Format((IFormatProvider)null, "Sequence P2 : Successfully caught the exception '{0}'",
                    exceptionMessage));
            }
        ...
        void ValidateSizeAddSequenceTestCases(string nodeName,
            ParserParameters parserParam)
        {
            ...
            switch (parserParam)
            {
                case ParserParameters.GenBank:
                    ...
                    break;
                default:
                    using (FastaParser fastaParser = new FastaParser())
                    {
        ...
        void ValidateInsertRemoveReplaceSequenceTestCases(string nodeName,
        ...
        /// <param name="parserParam">Fasta/GenBank</param>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        void ValidateReverseComplementSequenceTestCases(string nodeName,
            ParserParameters parserParam, AdditionalParameters addParam)
        {
            // Gets the expected sequence from the Xml
            string filePath = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            switch (addParam)
            {
                case AdditionalParameters.Reverse:
                    string revSeq = _utilityObj._xmlUtil.GetTextValue(nodeName,
                ...
                case AdditionalParameters.Complement:
                    string comSeq = _utilityObj._xmlUtil.GetTextValue(nodeName,
                ...
                case AdditionalParameters.ReverseComplement:
                    string revCompSeq = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        /// </summary>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        private static void ValidateSingleDnaAlphabetTestCases(AdditionalParameters addParam)
        {
            // Validation of Reverse(), Complement() and ReverseComplement() method
            switch (addParam)
            {
        ...
        /// <param name="nodeName">Xml Node name</param>
        /// <param name="parserParam">Fasta/GenBank</param>
        void ValidateSequenceTestCases(string nodeName,
            ParserParameters parserParam)
        {
            // Gets the expected sequence from the Xml
            string filePath = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        /// <param name="nodeName">Xml Node name</param>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        void ValidateCloningSequenceTestCases(string nodeName,
        ...
        /// </summary>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        private static void ValidateInvalidIndexTestCases(AdditionalParameters addParam)
        {
        ...
        /// <param name="parserParam">Fasta/GenBank</param>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        void ValidateReverseComplementDerivedSequenceTestCases(string nodeName,
            ParserParameters parserParam, AdditionalParameters addParam)
        {
            // Gets the expected sequence from the Xml
            string filePath = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            switch (addParam)
            {
                ...
                case AdditionalParameters.Complement:
                    ...
                    {
                        string comExcep = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        /// <param name="nodeName">Xml Node name</param>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        void ValidateBasicDerivedCloningSequenceTestCases(string nodeName,
            AdditionalParameters addParam)
        {
            // Gets the expected sequence from the Xml
            string filePath = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        /// <param name="parserParam">Fasta/GenBank</param>
        /// <param name="addParam">Additional Parameter to specify the method to execute</param>
        void ValidateBasicDerivedInsertSequenceTestCases(string nodeName,
            ParserParameters parserParam, AdditionalParameters addParam)
        {
            // Gets the expected sequence from the Xml
            string filePath = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            {
                case AdditionalParameters.Insert:
                    string expMessage = _utilityObj._xmlUtil.GetTextValue(nodeName,
                    ...
                    break;
                case AdditionalParameters.Remove:
                    string expRemoveMessage = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            AdditionalParameters methodName)
        {
            ...
            string sequence1 = _utilityObj._xmlUtil.GetTextValue(nodeName,
               Constants.Sequence1);
            string gapCharSequence = _utilityObj._xmlUtil.GetTextValue(nodeName,
               Constants.GapCharSeqNode);
            string expectedNullSeqMessage = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.NullSeqErrorMessageNode);
            string expectedStartPosError = _utilityObj._xmlUtil.GetTextValue(nodeName,
               Constants.StartPosErrorNode);
            string expectedEndPosError = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        /// <param name="nodeName">Node Name in the xml.</param>
        /// </summary>
        void InvalidateSequenceOperations(AdditionalParameters param)
        {
            // Get a expected values from the Xml
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.BasicSeqInfoNode,
                Constants.AlphabetNameNode);
            string sequenceString = _utilityObj._xmlUtil.GetTextValue(Constants.BasicSeqInfoNode,
               Constants.Sequence1);
            ...
            switch (param)
            {
                case AdditionalParameters.Range:
                    InvalidateSequenceRange(seq);
                    break;
                case AdditionalParameters.RemoveRange:
                    InvalidateSequenceRemoveRange(seq);
                    break;
                case AdditionalParameters.Replace:
                    InvalidateSequenceReplace(seq);
                    break;
                case AdditionalParameters.ReplaceSeqItem:
                    InvalidateSequenceReplaceSeqItem(seq);
                    break;
                case AdditionalParameters.ReplaceRange:
                    InvalidateSequenceReplaceRange(seq);
                    break;
                case AdditionalParameters.Insert:
                    InvalidateSequenceInsert(seq);
                    break;
                case AdditionalParameters.InsertRange:
                    InvalidateSequenceInsertRange(seq);
                    break;
                default:
                    break;
            }
        ...
        /// <summary>
        /// Invalidate ReplaceRange using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceReplaceRange(Sequence seq)
        {
        ...
        /// <summary>
        /// Invalidate ReplaceSeqItem using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceReplaceSeqItem(Sequence seq)
        {
        ...
        /// <summary>
        /// Invalidate Insert using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceInsert(Sequence seq)
        {
        ...
        /// <summary>
        /// Invalidate InsertRange using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceInsertRange(Sequence seq)
        {
        ...
        /// <summary>
        /// Invalidate Sequence Range using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceRange(Sequence seq)
        {
        ...
        /// <summary>
        /// Invalidate Sequence Remove Range using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceRemoveRange(Sequence seq)
        {
        ...
        /// <summary>
        /// Invalidate Sequence Replace using invalid values.
        /// </summary>
        /// <param name="seq">Insequence</param>
        static void InvalidateSequenceReplace(Sequence seq)
        {
