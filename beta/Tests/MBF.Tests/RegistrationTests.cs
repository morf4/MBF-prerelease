...
namespace MBF.Tests
{
    ...
    ///        
    /// Step 3: Compile the project and copy the MBF.Tests.dll under ...\MBF\MBF.Tests\bin\Add-ins
    ...
    public class RegistrationTests
    {
        ...
        {
            //IMPORTANT: To pass this test case, it required two folders under...\MBF\MBF.Tests\bin
            // 1. ...\MBF\MBF.Tests\bin\Core
            // 2. ...\MBF\MBF.Tests\bin\Add-ins
            // MBF.Tests.dll needs to be copied under Add-ins folder.
            ...
            if (null != registeredAligners && registeredAligners.Count > 0)
            {
                ...
                {
                    string name = null;
                    registeredAligners.FirstOrDefault(IA => string.Compare(name = IA.Name, aligner.Name,
        ...
        public void GetAssemblersTest()
        {
            ...
            if (null != registeredAssemblers && registeredAssemblers.Count > 0)
            {
                ...
                {
                    string name = null;
                    registeredAssemblers.FirstOrDefault(IA => string.Compare(name = IA.Name, assembler.Name,
                        StringComparison.OrdinalIgnoreCase) == 0);
        ...
        public void GetAlphabetsTest()
        {
            ...
            if (null != registeredAlphabets && registeredAlphabets.Count > 0)
            {
                ...
                {
                    string name = null;
                    registeredAlphabets.FirstOrDefault(IA => string.Compare(name = IA.Name, alphabet.Name,
                        StringComparison.OrdinalIgnoreCase) == 0);
        ...
        public void GetFormattersTest()
        {
            ...
            if (null != registeredFormatters && registeredFormatters.Count > 0)
            {
                ...
                {
                    string name = null;
                    registeredFormatters.FirstOrDefault(IA => string.Compare(name = IA.Name, formatter.Name,
                        StringComparison.OrdinalIgnoreCase) == 0);
        ...
        public void GetParsersTest()
        {
            ...
            if (null != registeredParsers && registeredParsers.Count > 0)
            {
                ...
                {
                    string name = null;
                    registeredParsers.FirstOrDefault(IA => string.Compare(name = IA.Name, parser.Name, StringComparison.OrdinalIgnoreCase) == 0);
    ...
    public sealed class New1Aligner4TestingRegistration : ISequenceAligner
    {
    ...
    /// </summary>
    [RegistrableAttribute(true)]
    public sealed class NewAssembler4TestingRegistration : IDeNovoAssembler
    {
    ...
    /// </summary>
    [RegistrableAttribute(true)]
    public sealed class NewAlphabet4TestingRegistration : IAlphabet
    {
    ...
    /// </summary>
    [RegistrableAttribute(true)]
    public sealed class NewParser4TestingRegistration : ISequenceParser
    {
