...
namespace MBF.Tests
{
    ...
    public class ByteArrayTests
    {
        ...
        public void TestByteArray()
        {
            ...
            seq = new Sequence(Alphabets.DNA, Encodings.Ncbi2NA, "CCGCGA", true);
            seq.IsReadOnly = true;
            seq.IsReadOnly = false;
            seq.Add(Alphabets.DNA.C);
            seq.Add(Alphabets.DNA.C);
            ...
            byte[] encodingValues = new byte[seq.Count];
            (seq as IList<byte>).CopyTo(encodingValues, 0);
            ...
            seq = new Sequence(Alphabets.DNA, Encodings.IupacNA, "AAAAAAADGY", true);
            encodingValues = new byte[seq.Count];
            (seq as IList<byte>).CopyTo(encodingValues, 0);
