...
namespace MBF.TestAutomation.Web.Blast
{
    ...
    public class BlastP1TestCases
    {
        ...
        public void ValidateAddMethodForSwissprotDatabaseValue()
        {
            ...
            string databaseParameter = _utilityObj._xmlUtil.GetTextValue(
                Constants.BlastDataBaseNode, Constants.DatabaseParameter);
            string defaultDataBaseValue = _utilityObj._xmlUtil.GetTextValue(
                Constants.BlastDataBaseNode, Constants.DefaultDatabaseValue);
            string expectedParametersCount = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateAddMethodForDifferentDatabaseValue()
        {
            ...
            string databaseParameter = _utilityObj._xmlUtil.GetTextValue(
                Constants.BlastDataBaseNode, Constants.DatabaseParameter);
            string swissprotDBValue = _utilityObj._xmlUtil.GetTextValue(
        ...
        {
            // Gets the search query parameter and their values.
            string programParameter = _utilityObj._xmlUtil.GetTextValue(
                Constants.BlastProgramNode, Constants.ProgramParameter);
            string tblastXValue = _utilityObj._xmlUtil.GetTextValue(
        ...
        {
            // Gets the search query parameter and their values.
            string optionalParameter = _utilityObj._xmlUtil.GetTextValue(
                Constants.BlastProgramNode, Constants.Expectparameter);
            string optionalParameterValue = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateGetBrowserProxyMethod()
        {
            ...
            string defaultTime = _utilityObj._xmlUtil.GetTextValue(
                Constants.ConfigurationParametersNode, Constants.DefaultTimeOut);
            string retryCount = _utilityObj._xmlUtil.GetTextValue(
                Constants.ConfigurationParametersNode, Constants.RetryCount);
            string retryInterval = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateConfigurationParameterswithStringValidator()
        {
            ...
            string email = _utilityObj._xmlUtil.GetTextValue(
                Constants.ConfigurationParametersNode, Constants.EmailAdress);
            string emailId1 = _utilityObj._xmlUtil.GetTextValue(
                Constants.ConfigurationParametersNode, Constants.EmailAdress1);
            string emailID2 = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateConfigurationParameterwithDoubleValidator()
        {
            ...
            string newParamterValue = _utilityObj._xmlUtil.GetTextValue(
                Constants.DoubleRangeParameterNode, Constants.newParameterValue);
            string lowestValue = _utilityObj._xmlUtil.GetTextValue(
                Constants.DoubleRangeParameterNode, Constants.lowestRange);
            string highestValue = _utilityObj._xmlUtil.GetTextValue(
        ...
        /// Input Data : Valid values.
        /// Output Data : No exceptions are thrown.
        /// </summary>
        [TestMethod]
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateBlastXmlMetadataGetObjectData()
        {
            SerializationInfo info = new SerializationInfo(typeof(BlastXmlMetadata),
            ...
            Console.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method successfully.");
            ApplicationLog.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method successfully.");
        }
        ...
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateHspMetadataGetObjectData()
        {
            SerializationInfo info = new SerializationInfo(typeof(Hsp),
                 new FormatterConverter());
            StreamingContext context = new StreamingContext(StreamingContextStates.All);
            ...
            Console.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of Hsp successfully.");
            ApplicationLog.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of Hsp successfully.");
        }
        ...
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateBlastResultGetObjectData()
        {
            SerializationInfo info = new SerializationInfo(typeof(BlastResult),
                 new FormatterConverter());
            StreamingContext context = new StreamingContext(StreamingContextStates.All);
            ...
            Console.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of Blast Result successfully.");
            ApplicationLog.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of Blast Result successfully.");
        }
        ...
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateBlastSearchRecordMetadataGetObjectData()
        {
            SerializationInfo info = new SerializationInfo(typeof(BlastSearchRecord),
                 new FormatterConverter());
            StreamingContext context = new StreamingContext(StreamingContextStates.All);
        ...
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateBlastStatisticsMetadataGetObjectData()
        {
            SerializationInfo info = new SerializationInfo(typeof(BlastStatistics),
                 new FormatterConverter());
            StreamingContext context = new StreamingContext(StreamingContextStates.All);
            ...
            Console.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of BlastStatistics successfully.");
            ApplicationLog.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of BlastStatistics successfully.");
        }
        ...
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateHitMetadataGetObjectData()
        {
            SerializationInfo info = new SerializationInfo(typeof(Hit),
                 new FormatterConverter());
            StreamingContext context = new StreamingContext(StreamingContextStates.All);
            ...
            Console.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of Hit successfully.");
            ApplicationLog.WriteLine("Ncbi Blast P1 : Validated the GetObjectData() method of Hit successfully.");
        }
            ...
            string expectParameter, string compositionBasedStaticParameter)
        {
            ...
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(
                nodeName, Constants.AlphabetNameNode);
            string optionalExpectParameter = _utilityObj._xmlUtil.GetTextValue(
                nodeName, Constants.BlastExpectParameter);
            string optionalExpectValue = _utilityObj._xmlUtil.GetTextValue(
                nodeName, Constants.BlastExpectparameterValue);
            string optionalCBSParameter = _utilityObj._xmlUtil.GetTextValue(
                nodeName, Constants.BlastCompositionBasedStaticsParameter);
            string optionalCBSParameterValue = _utilityObj._xmlUtil.GetTextValue(
