...
namespace MBF.TestAutomation
{
    ...
    public class SparseSequenceBvtTestCases
    {
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private static void ValidateSparseSequenceCopy(IAlphabet alphabet)
        {
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private static void ValidateSparseSequenceRemove(IAlphabet alphabet)
        {
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private static void ValidateSparseSequenceReplaceWithChar(IAlphabet alphabet)
        {
