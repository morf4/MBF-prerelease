    ...
    public class SequenceP1TestCases
    {
        ...
        public void ValidateAddRnaSequenceItem()
        {
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Sequence is as expected."));
            ...
            // Logs information to the log file
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The File exist in the Path ", fastAFilePath));
        ...
        public void ValidateAddGeneBankFileRnaSequenceItem()
        {
            ...
            // Logs information to the log file
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The File exist in the Path ", geneBankFilePath));
        ...
        public void ValidateAddFastAFileProteinSequenceItem()
        {
            ...
            string seqAfterAdd = string.Empty;
            string proteinAlphabetName = _utilityObj._xmlUtil.GetTextValue(
                Constants.SimpleProteinAlphabetNode, Constants.AlphabetNameNode);
            string proteinActualSequence = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateGeneBankFileSequenceDelete()
        {
            ...
            Assert.IsTrue(string.IsNullOrEmpty(seq.ToString()));
        ...
        public void ValidateInsertSequenceItem()
        {
            ...
            string actualSequence = _utilityObj._xmlUtil.GetTextValue(
                Constants.SimpleDnaAlphabetNode, Constants.ExpectedNormalString);
            string expectedSequenceAfterInsert = _utilityObj._xmlUtil.GetTextValue(
                Constants.SimpleDnaAlphabetNode, Constants.ExpectedSequenceAfterInsert);
            string seqAfterReplace = string.Empty;

            // Logs information to the log file
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Sequence ", actualSequence, " and Alphabet ", alphabetName));
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1 : The sequence count is as expected"));
        ...
        public void ValidateInsertSequenceItemWithDV()
        {
            ...
            using (FastaParser parserObj = new FastaParser())
            {
                ...
                seqList = parserObj.Parse(filePath);
            }
        ...
        public void ValidateInsertRangeWithDV()
        {
            ...
            byte[] tmpEncodedSeq = new byte[newSeqObj.Count];
            (newSeqObj as IList<byte>).CopyTo(tmpEncodedSeq, 0);

            Assert.AreEqual('A', newSeqObj[0].Symbol);
            Assert.AreEqual(886, tmpEncodedSeq.Length);
        ...
        public void ValidateMediumSizeGeneBankFileRnaSequenceInsertItem()
        {
            ...
            string geneBankFilePath = _utilityObj._xmlUtil.GetTextValue(
                Constants.MediumSizeGenBankNodeName, Constants.FilePathNode);
            string expectedSeqAfterInsert = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateInsertMethodAtFirstPosition()
        {
            ...
            string geneBankFilePath = _utilityObj._xmlUtil.GetTextValue(
                Constants.MediumSizeGenBankNodeName, Constants.FilePathNode);
            string expectedSeqAfterInsertAtfirstPlace = _utilityObj._xmlUtil.GetTextValue(
        ...
        public void ValidateRemoveAt()
        {
            ...
            string geneBankFilePath = _utilityObj._xmlUtil.GetTextValue(
                Constants.SimpleGenBankRnaNodeName, Constants.FilePathNode);
            string expectedSeqAfterRemove = _utilityObj._xmlUtil.GetTextValue(
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Sequence ", seqAfterRemove, " is expected."));
        }
        ...
        public void ValidateReplace()
        {
            ...
            string actualSequence = _utilityObj._xmlUtil.GetTextValue(
                Constants.SimpleDnaAlphabetNode, Constants.ExpectedNormalString);
            string expectedSequenceAfterReplace = _utilityObj._xmlUtil.GetTextValue(
            ...
            Assert.AreEqual(createSequence.ToString(), actualSequence);
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Sequence ", createSequence.ToString(), " is expected."));
        ...
        public void ValidateIndexOfSquenceItem()
        {
            ...
            // Logs information to the log file
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Sequence ", actualSequence, " and Alphabet ",
                alphabetName));
            ...
            Assert.AreEqual(seqIndex, 2);
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1 : The sequence count is as expected for Encoding",
        ...
        public void ValidateRnaBasicDerivedSequence()
        {
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Basic derived Sequence is as expected."));
        }
        ...
        public void ValidateBasicDerivedSequenceWithSmallSizeGenBankFormat()
        {
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The GenBank Sequence is as expected."));
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The GenBank Sequence Length is as expected."));
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The BasicDerived Sequence is expected."));
        ...
        public void ValidateBasicDerivedSequenceWithMediumSizeGenBankFormat()
        {
            ...
            // Logs information to the log file
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The File exist in the Path "));
            ...
            Assert.AreEqual(geneBankSeq.ToString(), basicDerivedSeq.ToString());
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The BasicDerived Sequence is as expected."));
        ...
        public void ValidateBasicDerivedSequenceWithSmallSizeFastAFormat()
        {
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The fastA Sequence is as expected."));

            byte[] tmpEncodedSeq = new byte[fastASeq.Count];
            (fastASeq as IList<byte>).CopyTo(tmpEncodedSeq, 0);
            Assert.AreEqual(expectedSequence.Length, tmpEncodedSeq.Length);
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: The fastA Sequence Length is as expected."));
        ...
        public void ValidateAlphabets()
        {
            ...
            string alphabetsCount = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleFastaRnaNodeName,
                Constants.AlphabetsCountNode);
            string rnaAlphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleRnaAlphabetNode,
                Constants.RnaAlphabetNode);
            string dnaAlphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleRnaAlphabetNode,
                Constants.DnaAlphabetNode);
            string proteinAlphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleRnaAlphabetNode,
            ...
            Assert.AreEqual(alphabetsCount, alphabetList.Count.ToString((IFormatProvider)null));
            ...
            ApplicationLog.WriteLine(string.Concat(
                "Alphabets :Alphabets validation is successful ",
                alphabetList.Count));
        }
        ...
        {
            // Get a expected values from the Xml
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.BasicSeqInfoLastIndexGapCharNode,
                Constants.AlphabetNameNode);
            string sequence = _utilityObj._xmlUtil.GetTextValue(Constants.BasicSeqInfoLastIndexGapCharNode,
                Constants.ExpectedNormalString);
        ...
        {
            // Get a expected values from the Xml
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleFastaNodeName,
                Constants.AlphabetNameNode);
            string sequence = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleFastaNodeName,
        ...
        public void ValidateBasicDerivedSequenceRemoveAt()
        {
            ...
            {
                Console.WriteLine(string.Concat("Successfully caught the exception ",
                    ex.Message));
                ApplicationLog.WriteLine(string.Concat("Successfully caught the exception ",
                    ex.Message));
            }
        }
        ...
        public void ValidateBasicDerivedSequenceStatisticsGetObjectData()
        {
            ...
            using (Stream stream = File.Open("Sequence.data", FileMode.Create))
            {
        ...
        {
            Sequence seq = new Sequence(Alphabets.DNA, Encodings.IupacNA, "GGCCTT");
            ...
            Assert.IsNotNull(tmpEncodedSeq);
        ...
        public void ValidateBasicDerivedCloneSequence()
        {
            ...
            Assert.AreEqual(basicDerivedCloneSeq.ToString(), rnaDerivedSeq.ToString());
            ApplicationLog.WriteLine(string.Concat(
                "Sequence P1: Basic derived Sequence is as expected."));

            // Validate Serialization
            using (Stream stream = File.Open("BasicDerivedSequence.data", FileMode.Create))
            {
                BinaryFormatter formatter = new BinaryFormatter();
        ...
        public void ValidateCopiedBasicDerivedSequenceItems()
        {
            ...
            for (int i = 0; i < rnaDerivedSeq.Count; i++)
            {
                ...
                Console.WriteLine(string.Concat(
                    "Qualitative Sequence P1:Qualitative Sequence is as expected."));
            }
        }
        ...
        /// </summary>
        void ValidateGeneralIndexOfNonGapChars(string nodeName,
            BasicSeqInformationMethodParameters methodName, bool IsPos)
        {

            // Get a expected values from the Xml
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.AlphabetNameNode);
            string sequence = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.ExpectedNormalString);
            string sequence1 = _utilityObj._xmlUtil.GetTextValue(nodeName,
               Constants.Sequence1);
            string expectedSeqPosWithNonGapChar = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.SeqPosWithNonGapCharNode);
            string expectedSeqPosWithGapChar = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            switch (methodName)
            {
                case BasicSeqInformationMethodParameters.Index:
                    ...
                    Assert.AreEqual(expectedSeqPosWithNonGapChar, pos.ToString((IFormatProvider)null));
                    Assert.AreEqual(expectedSeqPosWithGapChar, posWithGap.ToString((IFormatProvider)null));

                    if (IsPos)
                    {
                        posIndex = BasicSequenceInfo.IndexOfNonGap(seqWithGapChar,
                            int.Parse(expectedSeqPosWithGapChar, (IFormatProvider)null));
                        Assert.AreEqual(expectedSeqPosWithGapChar, posIndex.ToString((IFormatProvider)null));
                    }
                    ApplicationLog.WriteLine(string.Concat(
                        "BasicSequenceInfo :Validated Sequence first Index successfully ", pos));
                    Console.WriteLine(string.Concat(
                       "BasicSequenceInfo :Validated Sequence first Index successfully ", pos));
                    break;
                case BasicSeqInformationMethodParameters.LastIndex:
                    ...
                    ApplicationLog.WriteLine(string.Concat(
                        "BasicSequenceInfo :Validated Sequence Last Index successfully ", pos));
                    Console.WriteLine(string.Concat(
                        "BasicSequenceInfo :Validated Sequence Last Index successfully ", pos));
                    break;
                default:
        ...
        private static bool ValidatePattern(HashSet<string> expected, IList<string> actual)
        {
