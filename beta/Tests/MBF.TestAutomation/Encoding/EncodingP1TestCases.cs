...
namespace MBF.TestAutomation.Encoding
{
    ...
    public class EncodingP1TestCases
    {
        ...
        /// <summary>
        /// Validate SequenceDecoder GetObjectData() method.
        /// Input : Valid values.
        ...
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateSequenceDecoderGetObjectData()
        {
            SerializationInfo info = null;
            StreamingContext context = new StreamingContext(StreamingContextStates.All);

            SequenceDecoder sdObj = new SequenceDecoder(Encodings.IupacNA);
            try
            {
            ...
            {
                info = new SerializationInfo(typeof(SequenceDecoder),
                             new FormatterConverter());
                sdObj.GetObjectData(info, context);
            }

            Console.WriteLine("Sequence Decoder P1 : Successfully validated SequenceDecoder GetObjectData() method");
            ApplicationLog.WriteLine("Sequence Decoder P1 : Successfully validated SequenceDecoder GetObjectData() method");
        }
        ...
        /// <summary>
        /// Validate SequenceEncoder GetObjectData() method.
        /// Input : Valid values.
        /// Output : No exception are thrown.
        /// </summary>
        [TestMethod]
        [Priority(1)]
        [TestCategory("Priority1")]
        public void ValidateSequenceEncoderGetObjectData()
        {
            SerializationInfo info = null;
            StreamingContext context = new StreamingContext(StreamingContextStates.All);

            SequenceEncoder seObj = new SequenceEncoder(Encodings.IupacNA);
            try
            {
                seObj.GetObjectData(info, context);
                Assert.Fail();
            }
            catch (ArgumentNullException)
            {
                info = new SerializationInfo(typeof(SequenceEncoder),
                             new FormatterConverter());
                seObj.GetObjectData(info, context);
            }

            Console.WriteLine("Sequence Encoder P1 : Successfully validated SequenceEncoder GetObjectData() method");
            ApplicationLog.WriteLine("Sequence Encoder P1 : Successfully validated SequenceEncoder GetObjectData() method");
        }
        ...
        void InValidateEncodingAdd(IEncoding encoding)
        {
            ...
            Console.WriteLine(string.Format((IFormatProvider)null, "Encoding P1 : Validation of Add() method completed"));
        }
        ...
        {
            // Gets the actual sequence and the alphabet from the Xml
            string expectedString = _utilityObj._xmlUtil.GetTextValue(Constants.LookUpNode, lookUpInput);
            bool result = false;
            ...
            Console.WriteLine(string.Format((IFormatProvider)null, "Encoding P1 : Validation of contains() method is completed sucessfully."));
        }
        ...
        {
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(alphabetNode, Constants.AlphabetNameNode);
            string actualSequence = _utilityObj._xmlUtil.GetTextValue(alphabetNode, Constants.ExpectedSequence);
            bool result = false;
        ...
        /// </summary>
        /// <param name="encoding">Encoding instance.</param>
        private static void ValidateEncodingGetEnumerator(IEncoding encoding)
        {
            ...
            Console.WriteLine(string.Format((IFormatProvider)null, "Encoding P1 : Validation of GetEnumerator is completed."));
        }
        ...
        {
            // Get Value from xml.
            string expectedSymbol = _utilityObj._xmlUtil.GetTextValue(Constants.EncodingNode, alphabetSymbol);
            string encodedValue = _utilityObj._xmlUtil.GetTextValue(Constants.EncodingNode, byteValue);
            string itemLength = _utilityObj._xmlUtil.GetTextValue(Constants.EncodingNode, itemLengthNode);
            ...
            for (int seqCounter = 0; seqCounter < seqItems.Length; seqCounter++)
            {
                ...
                Assert.AreEqual(expectedSymbols[seqCounter], seqItems[seqCounter].Symbol.ToString((IFormatProvider)null));
            }
          ...
          string itemLengthNode, string alphabetNode)
        {
            ...
            string expectedSequence = _utilityObj._xmlUtil.GetTextValue(alphabetNode,
              Constants.ExpectedSequence);
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(alphabetNode, Constants.AlphabetNameNode);
            string itemLength = _utilityObj._xmlUtil.GetTextValue(Constants.EncodingNode, itemLengthNode);
        ...
        void ValidateEncodingLookUpByChar(IEncoding encoding, string lookUpInput, string lookUpOutput)
        {
            ...
            string inputString = _utilityObj._xmlUtil.GetTextValue(Constants.LookUpNode, lookUpInput);
            string expectedLookUpSymbol = _utilityObj._xmlUtil.GetTextValue(Constants.LookUpNode, lookUpOutput);
            ...
            foreach (char inputChar in inputString.ToCharArray())
            {
                ...
                Assert.AreEqual(seqItem.Symbol.ToString((IFormatProvider)null), expectedLookUpSymbol[index].ToString((IFormatProvider)null));
                index++;
            }
        ...
        void ValidateEncodingLookUpByString(IEncoding encoding, string alphabetNode)
        {
            ...
            foreach (char inputChar in actualSequence.ToCharArray())
            {
                ISequenceItem seqItem = encoding.LookupBySymbol(inputChar.ToString((IFormatProvider)null));
        ...
        void ValidateEncodingLookUpByString(IEncoding encoding, string lookUpInput, string lookUpOutput)
        {
            // Gets LookUp() values from xml.
            string inputString = _utilityObj._xmlUtil.GetTextValue(Constants.LookUpNode, lookUpInput);
            string expectedLookUpString = _utilityObj._xmlUtil.GetTextValue(Constants.LookUpNode, lookUpOutput);
            ...
            foreach (char inputChar in inputString.ToCharArray())
            {
                ...
                Assert.AreEqual(expectedLookUpString[index].ToString((IFormatProvider)null), seqItem.Symbol.ToString((IFormatProvider)null));
                index++;
            }
            Console.WriteLine(string.Format((IFormatProvider)null,
              "Encoding P1 : Validation of LookUp symbol by passing string is completed."));
        ...
        {
            // Gets LookUp() values from xml.
            string expectedSymbol = _utilityObj._xmlUtil.GetTextValue(Constants.EncodingNode, outputSymbol);
            string inputByteValue = _utilityObj._xmlUtil.GetTextValue(Constants.EncodingNode, inputByte);
            ...
            for (int byteIndexer = 0; byteIndexer < inputByteValues.Length; byteIndexer++)
            {
                ...
                // Validates LookUpBySymbol() if symbol matches expected symbol
                Assert.AreEqual(expectedSymbols[byteIndexer], seqItem.Symbol.ToString((IFormatProvider)null));
            }
        ...
        void ValidateEncodingLookUpBySymbol(IEncoding encoding, string alphabetNode)
        {
            ...
            foreach (ISequenceItem item in seq)
            {
                ...
                ISequenceItem seqItem = null;
                seqItem = encoding.LookupBySymbol(item.Symbol.ToString((IFormatProvider)null));
          ...
          string nodeName, IAlphabet alphabet, IEncoding encodings)
        {
            ...
            string actualSequence = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string encodedValue = _utilityObj._xmlUtil.GetTextValue(nodeName, encodingNode);
            string[] encodedValues = encodedValue.Split(',');
          ...
          string nodeName, IAlphabet alphabet, IEncoding encodings)
        {
            ...
            foreach (ISequenceItem seqItem in createSequence)
            {
                ...
                Assert.AreEqual(seqItem.Symbol.ToString((IFormatProvider)null), alphabetItem.Symbol.ToString((IFormatProvider)null));
                ApplicationLog.WriteLine(string.Format((IFormatProvider)null,
          ...
          string alphabetNode, IEncoding encodings)
        {
            ...
            string expectedSequence = _utilityObj._xmlUtil.GetTextValue(alphabetNode,
              Constants.ExpectedSequence);
            string expectedByteArray = _utilityObj._xmlUtil.GetTextValue(alphabetNode, encodingNode);
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(alphabetNode,
              Constants.AlphabetNameNode);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
          ...
          string alphabetNode, IEncoding encodings)
        {
            ...
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(alphabetNode, Constants.AlphabetNameNode);
            string actualSequence = _utilityObj._xmlUtil.GetTextValue(alphabetNode, Constants.ExpectedSequence);
            string encodedValue = _utilityObj._xmlUtil.GetTextValue(alphabetNode, encodingNode);
            string[] encodedValues = encodedValue.Split(',');
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
            ISequenceItem encodedSeqItem = null;
            ISequenceItem alphabetItem = null;
            ...
            foreach (ISequenceItem seqItem in createSequence)
            {
                ...
                Assert.AreEqual(actualSequence[iencoded].ToString((IFormatProvider)null), alphabetItem.Symbol.ToString((IFormatProvider)null));
                iencoded++;
            }
            ApplicationLog.WriteLine(string.Format((IFormatProvider)null,
              "Encoding P1 :Alphabet name {0} is expected.", alphabetItem.Symbol));
        ...
        void ValidateEncodingMapAlphabetProperty(string alphabetNode, IEncoding encodings)
        {
            ...
            foreach (ISequenceItem item in createSequence)
            {
                ...
                // Validate the alphabet sequence item.
                Assert.AreEqual(actualSequence[seqCounter].ToString((IFormatProvider)null), alphabetItem.Symbol.ToString((IFormatProvider)null));
                seqCounter++;
            }
            ApplicationLog.WriteLine(string.Format((IFormatProvider)null,
              "Encoding P1 :Alphabet name {0} is expected.", alphabetItem.Symbol));
        ...
        void ValidateSequenceDecoder(string decoderNode, IEncoding encodings)
        {
            ...
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(decoderNode, Constants.DecoderAlphabetName);
            string alphabetSymbol = _utilityObj._xmlUtil.GetTextValue(decoderNode, Constants.AlphabetSymbol);
            string inputByteValue = _utilityObj._xmlUtil.GetTextValue(decoderNode, Constants.DecoderByteValue);
            ...
            for (int ibyte = 0; ibyte < inputByteValues.Length; ibyte++)
            {
                ...
                Assert.AreEqual(alphabetNames[ibyte], decodedItem.Name.ToString((IFormatProvider)null));
                Assert.AreEqual(alphabetSymbols[ibyte], decodedItem.Symbol.ToString((IFormatProvider)null));
                ApplicationLog.WriteLine(string.Format((IFormatProvider)null,
        ...
        /// </summary>
        /// <param name="encoding">encoding instance.</param>
        private static void ValidateSequenceDecoderEncodingProperty(IEncoding encoding)
        {
        ...
        void ValidateSequenceEncoderWithDecoder(string alphabetNode, IEncoding encodings)
        {
            ...
            for (int ialpha = 0; ialpha < alphaList.Count; ialpha++)
            {
                ...
                ApplicationLog.WriteLine(string.Format((IFormatProvider)null,
                  "Encoding P1 : Alphabet sequence Item symbol {0} and value {1} is matching with the expected sequence item.", alphaList[ialpha].Symbol.ToString((IFormatProvider)null), alphaList[ialpha].Value.ToString((IFormatProvider)null)));
                Console.WriteLine(string.Format((IFormatProvider)null,
                  "Encoding P1 : Alphabet sequence Item symbol {0} and value {1} is matching with the expected sequence item.", alphaList[ialpha].Symbol.ToString((IFormatProvider)null), alphaList[ialpha].Value.ToString((IFormatProvider)null)));
            }
            ApplicationLog.WriteLine(
        ...
        {
            // Gets LookUp() values from xml.
            string inputSymbol = _utilityObj._xmlUtil.GetTextValue(alphabetNode, Constants.ExpectedSequence);
            string expectedByte = _utilityObj._xmlUtil.GetTextValue(alphabetNode, encodingNode);
