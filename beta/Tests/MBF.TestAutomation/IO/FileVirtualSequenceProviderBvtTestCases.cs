...
namespace MBF.TestAutomation.IO
{
    ...
    public class FileVirtualSequenceProviderBvtTestCases
    {
        ...
        public void ValidateFVSPAdd()
        {
            ...
            Assert.AreEqual(seqObj[0], provObj.GetISequenceItem(provObj.Count - 1));
        ...
        [Priority(0)]
        [TestCategory("Priority0")]
        public void ValidateFVSPCopyToCharArray()
        {
            FileVirtualSequenceProvider provObj =
                GetVirtualSequenceProvider();
        ...
        public void ValidateFVSPReplaceRange()
        {
            ...
            Assert.AreEqual(seqObj[3], provObj.GetISequenceItem(0));
            Assert.AreEqual(seqObj[2], provObj.GetISequenceItem(1));
