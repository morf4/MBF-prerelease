...
namespace MBF.TestAutomation.IO
{
    ...
    public class FileVirtualQualitativeSequenceProviderBvtTestCases
    {
        ...
        [Priority(0)]
        [TestCategory("Priority0")]
        public void ValidateFVQSPCopyToCharArray()
        {
            FileVirtualQualitativeSequenceProvider provObj =
                GetVirtualSequenceProvider();
            ...
            provObj.Add(seqObj[0]);
            char[] charArray = new char[provObj.Count];
            provObj.CopyTo(charArray, 0);
        ...
        public void ValidateFVQSPInsertRange()
        {
            ...
            Assert.AreEqual((byte)seqObj[0].Symbol, provObj[0]);
            Assert.AreEqual((byte)seqObj[1].Symbol, provObj[1]);
            Assert.AreEqual((byte)seqObj[2].Symbol, provObj[2]);
            Assert.AreEqual((byte)seqObj[3].Symbol, provObj[3]);
            Assert.AreEqual((byte)seqObj[4].Symbol, provObj[4]);
        ...
        public void ValidateFVQSPRemoveRange()
        {
            ...
            Assert.AreEqual(seqObj[1], provObj.GetISequenceItem(0));
        ...
        /// <summary>
        /// Validate GetScores() method.
        /// Input : valid sequence item.
        /// Validation : GetScores() method works as expected.
        /// </summary>
        [TestMethod]
        [Priority(0)]
        [TestCategory("Priority0")]
