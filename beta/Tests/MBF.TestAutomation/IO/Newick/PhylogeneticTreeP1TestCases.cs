...
namespace MBF.TestAutomation.IO.Newick
{
    ...
    public class PhylogeneticTreeP1TestCases
    {
        ...
        public void PhylogeneticTreeP1ParserValidateAllProperties()
        {
            ...
            string filePath = _utilityObj._xmlUtil.GetTextValue(Constants.OneNodePhyloTreeNodeName,
            ...
            using (NewickParser parser = new NewickParser())
            {
                ...
                switch (formatParam)
                {
                    ...
                    case FormatterParameters.FormatString:
                        ...
                        string expectedFormatString = _utilityObj._xmlUtil.GetTextValue(nodeName,
