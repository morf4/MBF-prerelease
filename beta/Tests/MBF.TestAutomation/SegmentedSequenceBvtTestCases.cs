...
namespace MBF.TestAutomation
{
    ...
    public class SegmentedSequenceBvtTestCases
    {
        ...
        public void ValidateSegmentedSequenceProperties()
        {
            ...
            string expectedReverse = _utilityObj._xmlUtil.GetTextValue(
                Constants.DnaSegSequenceListNode, Constants.Reverse);
            string expectedReverseComplement = _utilityObj._xmlUtil.GetTextValue(
                Constants.DnaSegSequenceListNode, Constants.ReverseComplement);
            string expectedASymbolCount = _utilityObj._xmlUtil.GetTextValue(
            ...
            string displayId = _utilityObj._xmlUtil.GetTextValue(
            ...
            Assert.IsNotNull(segmentedSeq.Metadata);
            Assert.AreEqual(expectedASymbolCount,
                segmentedSeq.Statistics.GetCount('A').ToString((IFormatProvider)null));
        ...
        [Priority(0)]
        [TestCategory("Priority0")]
        public void ValidateSegmentedSequenceFindMatches()
        {
            ISequence seq = new Sequence(Alphabets.DNA, "ACCGGTT");
            SegmentedSequence ssObj =
                new SegmentedSequence(seq);
