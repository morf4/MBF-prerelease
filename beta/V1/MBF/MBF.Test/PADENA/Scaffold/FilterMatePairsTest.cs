...
namespace MBF.Test
{
    ...
    /// </summary>
    [TestFixture]
    public class FilterMatePairsTest : ParallelDeNovoAssembler
    {
        static FilterMatePairsTest()
        {
        ...
        private List<ValidMatePair> Sort(IList<ValidMatePair> list, IList<ISequence> reads)
        {
