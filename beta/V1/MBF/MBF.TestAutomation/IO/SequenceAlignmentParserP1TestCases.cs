...
namespace MBF.TestAutomation.IO
{
    ...
    public class SequenceAlignmentParserP1TestCases
    {
        ...
        static SequenceAlignmentParserP1TestCases()
        {
            ...
            Utility._xmlUtil = new XmlUtility(@"TestUtils\SequenceAlignmentParser.xml");
        }
        ...
        public void ValidateSeqParserProperties()
        {
            ...
            string samParserName = Utility._xmlUtil.GetTextValue(Constants.SamFileParserNode,
                Constants.ParserNameNode);
            string bamParserName = Utility._xmlUtil.GetTextValue(Constants.BamFileParserNode,
                Constants.ParserNameNode);
        ...
        {
            // Gets the expected sequence from the Xml
            string samFormatterName = Utility._xmlUtil.GetTextValue(Constants.SamFileParserNode,
                Constants.ParserNameNode);
            string bamFormatterName = Utility._xmlUtil.GetTextValue(Constants.BamFileParserNode,
                Constants.ParserNameNode);
