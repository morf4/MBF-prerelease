...
namespace MBF.TestAutomation.IO
{
    ...
    public class VirtualAlignedSequenceListP1Cases
    {
        ...
        {
            // Get values from XML node.
            string expectedCount = Utility._xmlUtil.GetTextValue(Constants.SAMFileWithAllFieldsNode,
            ...
            Assert.AreEqual(Int32.Parse(expectedCount),
        ...
        public void ValidateReadOnlyAlignedSeqProperties()
        {
            ...
            Assert.AreEqual(expectedCount, readOnlyAlignedSeq.Count.ToString());
