...
namespace MBF.TestAutomation.Matrix
{
    ...
    double.NaN);
            ...
            Assert.AreEqual("3", pdObj.RowCount.ToString());
            Assert.AreEqual("4", pdObj.ColCount.ToString());
        ...
        public void ValidatePaddedDoubleGetInstance()
        {
            ...
            Assert.AreEqual(denseMatObj.RowKeys, pdObj.RowKeys);
            Assert.AreEqual(denseMatObj.ColKeys, pdObj.ColKeys);
        ...
        public void ValidatePaddedDoubleGetInstanceFromSparse()
        {
            ...
            Assert.AreEqual(sparseMatObj.RowKeys, pdObj.RowKeys);
            Assert.AreEqual(sparseMatObj.ColKeys, pdObj.ColKeys);
        ...
        public void ValidatePaddedDoubleTryGetInstanceFromSparsePD()
        {
            ...
            Assert.AreEqual(sparseMatObj.RowKeys, padDoubObj.RowKeys);
            Assert.AreEqual(sparseMatObj.ColKeys, padDoubObj.ColKeys);
