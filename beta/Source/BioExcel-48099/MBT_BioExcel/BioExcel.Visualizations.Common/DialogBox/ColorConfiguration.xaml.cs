// ------------------------------------------------------------------------------
// <copyright file="ColorConfiguration.xaml.cs" company="Microsoft">
...
namespace BioExcel.Visualizations.Common
{
    ...
    public partial class ColorConfiguration : System.Windows.Window
    {
        ...
        /// </summary>
        private Dictionary<string, System.Drawing.Color> colorMap;
        ...
        public ColorConfiguration(Microsoft.Office.Interop.Excel.Application excelApplication, Dictionary<string, System.Drawing.Color> colorMap)
        {
            InitializeComponent();
        ...
        /// </summary>
        public Dictionary<string, System.Drawing.Color> ColorMap
        {
            get 
            { 
        ...
        {
            int index = 0;
            foreach (string symbol in this.colorMap.Keys)
            {
                ColorScheme scheme = new ColorScheme();
                scheme.MoleculeLabel = symbol;
        ...
        private void OnOkClick(object sender, RoutedEventArgs e)
        {
            foreach (Panel panel in this.stackPanels)
            {
                foreach (UIElement element in panel.Children)
                {
                    ...
                    if (scheme != null)
                    {
                        if (this.colorMap.ContainsKey(scheme.MoleculeLabel))
                        {
                            System.Windows.Media.Color colorShade = scheme.ChosenColor;
                            this.colorMap[scheme.MoleculeLabel] = System.Drawing.Color.FromArgb(colorShade.A, colorShade.R, colorShade.G, colorShade.B);
                        }
                    }
                }
            }
