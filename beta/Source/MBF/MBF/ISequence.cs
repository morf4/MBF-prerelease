...
namespace MBF
{
    ...
    /// </summary>
    public interface ISequence : IList<ISequenceItem>, IList<byte>, ICloneable, ISerializable
    {
        /// <summary>
        ...
        #region Implementations of IList<ISeuqenceItem> to remove ambiguity with IList<byte
        ...
        /// </summary>
        new ISequenceItem this[int index] { get; set; }
        ...
        new IEnumerator<ISequenceItem> GetEnumerator();
