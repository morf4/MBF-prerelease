...
%MSBUILDPATH%\msbuild.exe %SPATH%\MBI.sln /p:Configuration=Debug;OutDir=%BPATH%\Debug\
%MSBUILDPATH%\msbuild.exe %SPATH%\MBI.sln /p:Configuration=Release;OutDir=%BPATH%\Release\
