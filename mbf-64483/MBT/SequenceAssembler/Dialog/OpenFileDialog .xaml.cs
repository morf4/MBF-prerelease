...
// The file types that are supported by the MBF can
...
namespace SequenceAssembler
{
    ...
    public partial class OpenFileDialog : Window
    {
        ...
        /// </summary>
        private Collection<FileInfo> fileInfo;
        ...
        public OpenFileDialog(Collection<string> types, Collection<FileInfo> info, bool showFileBrowserAtStartup = false)
        {
        ...
        private void OnImportButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            {       
                ...
                {
                    this.fileInfo = new Collection<FileInfo>();
                }

                this.fileInfo.Add(info);
            }

            ImportFileEventArgs importArgs = new ImportFileEventArgs(this.fileNames, this.molecule, this.fileInfo, this.parser);
        ...
        private FileDialogFilterBuilder CreateFormatFilter()
        {
            ...
            {
                FilterInfo info = new FilterInfo(this.fileTypeHeaders[this.extensionsList.IndexOf(filters)]);
                info.SetExtensions(filters);
                filter.Info.Add(info);                
            }

            //// Create All files type: This would enable the User to select all the Files supported 
            //// by the Sequence Assembler            
        ...
        private void OnBrowseButtonClick(object sender, RoutedEventArgs e)
        {
            ...
            this.LaunchWindowFileDialog(fileDialog);
        }
        ...
        private void LaunchWindowFileDialog(System.Windows.Forms.OpenFileDialog fileDialog)
        {
            ...
            if (fileDialog.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                ISequenceParser autoParser = null;
                ISequenceParser prevParser = null;
                ...
                foreach (string file in fileDialog.FileNames)
                {
                    ...
                    autoParser = SequenceParsers.FindParserByFile(file);
                    ...
                    if (fileDialog.FileNames[0].Equals(file))
                    {
                     ...
                     if (autoParser == null || prevParser == null || !autoParser.Name.Equals(prevParser.Name))
                    {
                ...
                else
                {
                    ...
                    {
                       ISequenceParser parser = item.Tag as ISequenceParser;

                       if (parser != null && autoParser != null)
                       {
                           if (parser.Name.Equals(autoParser.Name))
                           {
        ...
        private void OnParserSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            else
            {
                ...
                this.parser = item.Tag as ISequenceParser;
            }
        }
