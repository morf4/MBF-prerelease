...
namespace MBF.Matrix
{
    ...
    public class MatrixFactory<TRowKey, TColKey, TValue>
    {
        ...
        static Tuple<string, string>[] _defaultParserNames = new []{
            Tuple.Create("MBF.Matrix.DenseAnsi", "TryGetInstance"),
            Tuple.Create("MBF.Matrix.PaddedDouble", "TryGetInstance"),
            Tuple.Create("MBF.Matrix.SparseMatrix", "TryParseSparseFile"),
            Tuple.Create("MBF.Matrix.DenseMatrix", "TryParseRFileWithDefaultMissing"),
            Tuple.Create("MBF.Matrix.DenseMatrix", "TryParseTabbedRFileWithDefaultMissing"),
            Tuple.Create("MBF.Matrix.DenseAnsi", "TryParseDenseAnsiFormatAsDoubleMatrix"),
            Tuple.Create("MBF.Matrix.DenseAnsi", "TryParseDenseAnsiFormatAsGenericMatrix")
        };
