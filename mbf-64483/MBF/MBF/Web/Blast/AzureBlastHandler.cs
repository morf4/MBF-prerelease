...
namespace Bio.Web.Blast
{
    ...
    /// </summary>
    public class AzureBlastHandler : IBlastServiceHandler
    {
        #region Constants
        ...
        /// </summary>
        private BlastServiceClient _blastClient;
        ...
        {
            get { return Resource.AZURE_BLAST_DESCRIPTION; }
        }
        ...
        public string Name
        {
            get { return Resource.AZURE_BLAST_NAME; }
        }
        ...
        public bool CancelRequest(string requestIdentifier)
        {
            ...
            try
            {
                return _blastClient.KillJob(new Guid(requestIdentifier));
            }
            catch (FaultException<BlastFault> fault)
            {
                throw new Exception(fault.Detail.Detail);
                ...
                BlastParameters parameters)
        {
            ...
            blastParameter.Owner = Resource.OWNERVALUE;
        ...
        private ParameterValidationResult ValidateParameters(BlastParameters parameters)
        {
            ...
            {
                result.IsValid = false;
                result.ValidationErrors += Resource.PARAMETERFORMATTYPENOTALLOWED;
            }
                ...
                switch (parameter.Key)
                {
                    ...
                    default:
                        ...
                        result.ValidationErrors += string.Format(
                            Resource.PARAMETERUNKNOWNAZURE,
                            parameter.Key);
                        break;
                }
            }
