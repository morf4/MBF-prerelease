...
namespace MBF.IO
{
    ...
    public class MBFTextReader : IDisposable
    {
        ...
        /// next line.</param>
        public MBFTextReader(TextReader reader, int dataIndent, bool skipBlandLines)
        ...
        /// <param name="skipBlandLines">Whether to skip blank lines when reading the
        /// next line.</param>
        public MBFTextReader(string fileName, int dataIndent, bool skipBlandLines)
        ...
        /// <param name="skipBlandLines">Whether to skip blank lines when reading the
        /// next line.</param>
        public MBFTextReader(Stream stream, int dataIndent, bool skipBlandLines)
