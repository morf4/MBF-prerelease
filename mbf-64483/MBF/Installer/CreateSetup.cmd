...
IF EXIST ..\..\Build\Installer.TMP (
rmdir /s /q ..\..\Build\Installer.TMP 
) ELSE ( 
mkdir ..\..\Build\Installer.TMP )

mkdir ..\..\Build\Installer.TMP\Binaries

SET SPATH=..\..
SET BPATH=..\..\Build\Installer.TMP\Binaries
...
%MSBUILDPATH%\msbuild.exe %SPATH%\MBF\MBF.sln /p:Configuration=Debug;OutDir=%BPATH%\Debug\
%MSBUILDPATH%\msbuild.exe %SPATH%\MBF\MBF.sln /p:Configuration=Release;OutDir=%BPATH%\Release\
...
CALL ..\..\BuildScripts\PostBuildScriptsForDailyBuild.cmd %SPATH% %BPATH% true
