...
namespace MBF.TestAutomation.PAMSAM
{
    ...
    public class PamSamP1TestCases
    {
        ...
        Utility _utilityObj = new Utility(@"TestUtils\MSAConfig.xml");
        ...
        void Initialize(string nodeName, string expectedScoreNode)
        {
            ...
            MoleculeType molType = MoleculeType.DNA;
            ...
            string sequenceString1 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence1);
            string sequenceString2 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence2);
            string sequenceString3 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence3);
            string sequenceString4 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence4);
            string sequenceString5 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence5);
            string sequenceString6 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence6);
            string sequenceString7 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence7);
            ...
            sequenceString1 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode1);
            sequenceString2 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode2);
            sequenceString3 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode3);
            sequenceString4 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode4);
            sequenceString5 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode5);
            sequenceString6 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode6);
            sequenceString7 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode7);
            sequenceString8 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode8);
            ...
            expectedScore = _utilityObj._xmlUtil.GetTextValue(nodeName, expectedScoreNode);
            ...
            PAMSAMMultipleSequenceAligner msa = new PAMSAMMultipleSequenceAligner(
                lstSequences,
                molType, kmerLength, DistanceFunctionTypes.EuclideanDistance,
                UpdateDistanceMethodsTypes.Average,
                ProfileAlignerNames.NeedlemanWunschProfileAligner,
        ...
        void InitializeStage1Variables(string nodeName)
        {
            ...
            string sequenceString1 = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Stage1ExpectedSequenceNode1);
            string sequenceString2 = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Stage1ExpectedSequenceNode2);
            string sequenceString3 = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Stage1ExpectedSequenceNode3);
            string sequenceString4 = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Stage1ExpectedSequenceNode4);
            string sequenceString5 = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Stage1ExpectedSequenceNode5);
            string sequenceString6 = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Stage1ExpectedSequenceNode6);
            string sequenceString7 = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            stage1ExpectedScore = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        void InitializeStage2Variables(string nodeName)
        {
            ...
            stage2ExpectedScore = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        void InitializeStage3Variables(string nodeName)
        {
            ...
            stage3ExpectedScore = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        void AddOneLineSequences(string nodeName)
        {
            ...
            string sequenceString8 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence8);
            string sequenceString9 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence9);
            string sequenceString10 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Sequence10);
            ...
            sequenceString8 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode8);
            sequenceString9 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode9);
            sequenceString10 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode10);
            ...
            bool addOnelineSequences, bool IsAlignForMoreSeq)
        {
            ...
            PAMSAMMultipleSequenceAligner msa = new PAMSAMMultipleSequenceAligner(lstSequences,
                moleculeType, kmrlength, distanceFunctionName, hierarchicalClusteringMethodName,
            ...
            bool IsAlignStage1)
        {
            ...
            foreach (ISequence seq in msa.AlignedSequencesA)
            {
                if (IsAlignStage1)
                {
                    Assert.AreEqual(stage1ExpectedSequences[index].ToString(),
                        seq.ToString());
                    index++;
                }
            }
            ...
            bool IsStageAlignment)
        {
            ...
            foreach (ISequence seq in msa.AlignedSequencesC)
            {
                if (IsStageAlignment)
                {
                    Assert.AreEqual(stage3ExpectedSequences[index].ToString(), seq.ToString());
                    index++;
                }
            }
        ...
        void ValidateDistanceMatrix(string nodeName, IDistanceMatrix matrix)
        {
            ...
            string expectedDimension = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Dimension);
            string expectedMinimumValue = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.MinimumValue);
            string expectedNearestDistances = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            List<BinaryGuideTreeEdge> edges)
        {
            ...
            string expectedEdgeCount = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.EdgesCount);
            string expectedNodesLeftChild = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.NodesLeftChild);
            string expectedNodesRightChild = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.NodesRightChild);
            string expectednode = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Nodes);
            ...
            DistanceFunctionTypes distanceFunctionName)
        {
            // Generate DistanceMatrix
            KmerDistanceMatrixGenerator kmerDistanceMatrixGenerator =
                new KmerDistanceMatrixGenerator(lstSequences, kmrlength, moleculeType, distanceFunctionName);
        ...
        {
            string rootId = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.RootId);
            string leavesCount = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.LeavesCount);
            string expectedNodesLeftChild = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.NodesLeftChild);
            string expectedNodesRightChild = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.NodesRightChild);
        ...
        void ValidateProfileAlignerGenerateEString(string nodeName, MoleculeType moleculeType, int edgeIndex)
        {
            ...
            string expectedTreeEdges = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.SubTreeEdges);
            string expectedTreeRoot = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.SubTreeRoots);
        ...
        void ValidateProfileExtraction(string nodeName, MoleculeType moleculeType, int edgeIndex)
        {
            ...
            string expectedColSize = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ColumnSize);
            string expectedProfileCount = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ProfileMatrix);
        ...
        void ValidateGenerateProfileAlignmentWithSequences(string nodeName, MoleculeType moleculeType)
        {
            ...
            string expectedColSize = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.ColumnSize);
            string expectedRowSize = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.RowSize);
            ...
            MoleculeType moleculeType, int edgeIndex)
        {
            ...
            Console.WriteLine("Stage1 Sequence : {0}", sequence.ToString());
            Assert.IsTrue(expectedSequence.Contains(sequence.ToString()));
        ...
        {
            string inputFilePath = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.FilePathNode);
            string refFilePath = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.RefFilePathNode);
            ...
            try
            {
                ...
                switch (scoreType)
                {
                    case ScoreType.QScore:
                        string expectedQScore = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.QScoreNode);
                        ...
                        Assert.IsTrue(expectedQScore.Contains(qScore.ToString((IFormatProvider)null)));
                        break;
                    case ScoreType.TCScore:
                        string expectedTCScore = _utilityObj._xmlUtil.GetTextValue(nodeName,
                    ...
                    case ScoreType.Offset:
                        string expectedResiduesCount = _utilityObj._xmlUtil.GetTextValue(nodeName,
                    ...
                    case ScoreType.MultipleAlignmentScoreFunction:
                        string expectedScore = _utilityObj._xmlUtil.GetTextValue(nodeName,
                            Constants.ExpectedScoreNode);
                        ...
                        Assert.IsTrue(expectedScore.Contains(score.ToString((IFormatProvider)null)));
                        break;
                    case ScoreType.PairWiseScoreFunction:
                        string expectedPairwiseScore = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            MoleculeType moleculeType, int edgeIndex, FunctionType functionType)
        {
            ...
            switch (functionType)
            {
                case FunctionType.Correlation:
                    ...
                    string expectedCorrelation = _utilityObj._xmlUtil.GetTextValue(nodeName,
                ...
                case FunctionType.FindMaxIndex:
                    string expectedMaxIndex = _utilityObj._xmlUtil.GetTextValue(nodeName,
                ...
                case FunctionType.JensenShanonDivergence:
                    string expectedJsDivergence = _utilityObj._xmlUtil.GetTextValue(nodeName,
                ...
                case FunctionType.KullbackLeiblerDistance:
                    string expectedKlDistance = _utilityObj._xmlUtil.GetTextValue(nodeName,
