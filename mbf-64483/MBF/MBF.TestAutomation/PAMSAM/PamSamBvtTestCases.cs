...
namespace MBF.TestAutomation.PAMSAM
{
    ...
    public class PamSamBvtTestCases
    {
        ...
        void InitializeStage1Variables(string nodeName)
        {
            ...
            string sequenceString1 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode1);
            string sequenceString2 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode2);
            string sequenceString3 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode3);
            string sequenceString4 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode4);
            string sequenceString5 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode5);
            string sequenceString6 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode6);
            string sequenceString7 = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedSequenceNode7);
            ...
            stage1ExpectedScore = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Stage1ExpectedScoreNode);
        ...
        void ValidateDistanceMatrix(string nodeName, IDistanceMatrix matrix)
        {
            ...
            string expectedMinimumValue = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.MinimumValue);
          ...
          List<BinaryGuideTreeNode> nodes, List<BinaryGuideTreeEdge> edges)
        {
            ...
            string expectedEdgeCount = _utilityObj._xmlUtil.GetTextValue(nodeName,
            ...
            string expectednode = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.Nodes);
            ...
            int kmrLength, MoleculeType moleculeType)
        {
            ...
            string seqIndicesString = _utilityObj._xmlUtil.GetTextValue(nodeName,
        ...
        void ValidateBinaryTree(BinaryGuideTree binaryTree, string nodeName)
        {
            ...
            string expectedNodesRightChild = _utilityObj._xmlUtil.GetTextValue(nodeName,
                Constants.NodesRightChild);
            string expectenode = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.Nodes);
            ...
            try
            {
                ...
                switch (scoretype)
                {
                    ...
                    case ScoreType.TCScore:
                        string expectedTCScore = _utilityObj._xmlUtil.GetTextValue(nodeName, Constants.TCScoreNode);
                ...
                Console.WriteLine(
                    String.Format((IFormatProvider)null, @"PamsamBvtTest:{0} validation completed successfully for molecule type {1}",
                    scoretype.ToString(),
                    type));
