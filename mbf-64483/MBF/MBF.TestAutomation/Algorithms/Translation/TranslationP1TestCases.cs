...
namespace MBF.TestAutomation.Algorithms.Translation
{
    ...
    public class TranslationP1TestCases
    {
        ...
        void ValidateDnaToRnaTranscribe(string sequenceNode, string transcribeNode)
        {
            ...
            string expectedSeq = _utilityObj._xmlUtil.GetTextValue(Constants.TranscribeNode,
                sequenceNode);
            string expectedTranscribe = _utilityObj._xmlUtil.GetTextValue(Constants.TranscribeNode,
                transcribeNode);
        ...
        void ValidateRnaToDnaReverseTranscribe(string sequenceNode, string revTranscribeNode)
        {
            ...
            string alphabetName = _utilityObj._xmlUtil.GetTextValue(Constants.SimpleRnaAlphabetNode,
                Constants.AlphabetNameNode);
            string expectedRnaSeq = _utilityObj._xmlUtil.GetTextValue(Constants.TranscribeNode,
                sequenceNode);
            string expectedReverseTranscribe = _utilityObj._xmlUtil.GetTextValue(Constants.TranscribeNode,
                revTranscribeNode);
