...
namespace MBF.Test
{
    ...
    public class IndexedItemTest
    {
        ...
        public void TestIndexedItemWithISequenceItem()
        {
            ...
            Assert.LessOrEqual(item3, item1);
            Assert.LessOrEqual(item2, item1);
            Assert.Less(item3, item1);
            Assert.Greater(item1, item3);
            Assert.GreaterOrEqual(item1, item3);
            Assert.GreaterOrEqual(item1, item2);
