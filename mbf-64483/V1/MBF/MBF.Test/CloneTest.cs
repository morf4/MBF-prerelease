...
namespace MBF.Test
{
    ...
    public class CloneTest
    {
        ...
        {
            ApplicationLog.WriteLine("SequenceClone test started");

            string seqData = "ACGAACCGGAAACCCGGG";

            Sequence orgSeq = new Sequence(Alphabets.DNA, seqData);
            ApplicationLog.WriteLine("Original Sequence: " + orgSeq.ToString());
            ...
            ApplicationLog.WriteLine("Cloned Sequence: " + cloneSeq);
            ...
            ApplicationLog.WriteLine("Original Sequence After modifying the cloned sequence: " + orgSeq.ToString());
            ...
            ApplicationLog.WriteLine("SequenceClone test completed");
        }
