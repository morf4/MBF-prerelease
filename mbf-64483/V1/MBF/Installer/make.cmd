...
CALL "%WIXTOOLS%\light" -nologo -sice:ICE05 -out %SETUP%\MBF.msi Framework.wixobj SDKComponents.wixobj VStemplateComponents.wixobj FrameworkUILib.wixlib -loc %UI%\MBF_WixUI_en-us.wxl -ext "%WIXTOOLS%\WixUIExtension.dll" -ext "%WIXTOOLS%\WixUtilExtension.dll"
