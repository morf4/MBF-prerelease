...
namespace MBF.Algorithms.Alignment.MultipleSequenceAlignment
{
    ...
    public class KmerDistanceMatrixGenerator : IDistanceMatrixGenerator
    {
        ...
        public KmerDistanceMatrixGenerator(List<ISequence> sequences, int kmerLength, MoleculeType moleculeType)
            : this(sequences, kmerLength, moleculeType, DistanceFunctionTypes.EuclideanDistance)
        {
        }
