...
namespace MBF.TestAutomation
{
    ...
    public class SegmentedSequenceP1TestCases
    {
        ...
        /// <summary>
        /// Validate Segmented Sequences ToString()
        /// Input Data : Valid DNA sequence.
        /// Output Data : Validation of ToString().
        /// </summary>
        [Test]
        ...
        public void ValidateLastIndexOfNonGapCharacters()
        {
            ...
            Stream stream = File.Open("SegmentedSequence.data", FileMode.Create);
            ...
            bool IsCloneMethod)
        {
            ...
            if (!IsCloneMethod)
            {
                ...
                Console.WriteLine(string.Format(null,
                    ...
                    segmentedSeq.Sequences.Count.ToString()));
                Console.WriteLine(string.Format(null,
            ...
            string nodeName, SegmentedSequenceParameters methodName)
        {
            ...
            string expectedIndexValue = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.ExpectedIndexValue);
            string insertSeq = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.InsertSeq);
            string expectedInsertSeq = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.ExpectedInsertSeq);
            string expectedRangeSeq = Utility._xmlUtil.GetTextValue(
            ...
            string expectedSeqAfterRemoveSeq = Utility._xmlUtil.GetTextValue(
            ...
            string expectedSeqAfterReplaceSeqRange = Utility._xmlUtil.GetTextValue(
            ...
            switch (methodName)
            {
                ...
                case SegmentedSequenceParameters.IndexOf:
                    ...
                    Assert.AreEqual(indexValue, Convert.ToInt32(expectedIndexValue));
                    break;
                case SegmentedSequenceParameters.InsertChar:
                    ...
                    Assert.AreEqual(segmentedSeq.Count, Convert.ToInt32(expectedSegSeqCount) + 1);
                    break;
                case SegmentedSequenceParameters.InsertRange:
                    ...
                    Assert.AreEqual(segmentedSeq.Count,
                        Convert.ToInt32(expectedSegSeqCount) + insertSeq.Length);
                    break;
