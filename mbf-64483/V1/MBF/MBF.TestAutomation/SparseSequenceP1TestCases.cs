...
namespace MBF.TestAutomation
{
    ...
    public class SparseSequenceP1TestCases
    {
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceInsert(IAlphabet alphabet)
        {
            SparseSequence sparseSeq = new SparseSequence(alphabet);
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceInsertWithChar(IAlphabet alphabet)
        {
            SparseSequence sparseSeq = new SparseSequence(alphabet);
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceClearAndAdd(IAlphabet alphabet)
        {
            SparseSequence sparseSeq = CreateSparseSequence(alphabet, 10);
            sparseSeq.IsReadOnly = false;
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceContains(IAlphabet alphabet)
        {
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceReplaceRange(IAlphabet alphabet)
        {
            // Create sequence item array
            ISequenceItem[] sequenceItemArray = new ISequenceItem[alphabet.Count];
            int index = 0;
            ...
            {
                sequence += sequenceItemArray[relpaceIndex].Symbol.ToString();
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceRemoveAt(IAlphabet alphabet)
        {
            SparseSequence sparseSequence = CreateSparseSequence(alphabet, 0);
            sparseSequence.IsReadOnly = false;
        ...
        /// </summary>
        /// <param name="alphabet">alphabet instance.</param>
        private void ValidateSparseSequenceRange(IAlphabet alphabet)
        {
            SparseSequence sparseSequence = CreateSparseSequence(alphabet, 10);
            sparseSequence.IsReadOnly = false;
            ...
            foreach (ISequenceItem item in alphabet)
            {
                expectedsequence += item.Symbol.ToString();
                index++;
