...
namespace MBF.TestAutomation.IO.Newick
{
    ...
    public class PhylogeneticTreeP1TestCases
    {
        ...
        static PhylogeneticTreeP1TestCases()
        {
            ...
            Utility._xmlUtil = new XmlUtility(@"TestUtils\PhylogeneticTestsConfig.xml");
        }
        ...
        public void PhylogeneticTreeP1ParserValidateAllProperties()
        {
            ...
            string filePath = Utility._xmlUtil.GetTextValue(Constants.OneNodePhyloTreeNodeName,
        ...
        static void PhylogeneticTreeParserGeneralTests(string nodeName,
            AdditionalParameters addParam)
        {
            ...
            string rootBranchCount = Utility._xmlUtil.GetTextValue(nodeName,
            ...
            string[] expectedLeavesName = Utility._xmlUtil.GetTextValue(nodeName,
               Constants.NodeNamesNode).Split(',');

            string[] expectedLeavesDistance = Utility._xmlUtil.GetTextValue(nodeName,
        ...
        static void PhylogeneticTreeFormatterGeneralTests(string nodeName,
            FormatterParameters formatParam)
        {
            ...
            switch (formatParam)
            {
                ...
                case FormatterParameters.ParseTextReader:
                    filePath = Utility._xmlUtil.GetTextValue(nodeName,
                        Constants.FilePathNode);
                    Assert.IsTrue(File.Exists(filePath));
            ...
            string outputFilepath = Utility._xmlUtil.GetTextValue(nodeName,
            ...
            switch (formatParam)
            {
                ...
                case FormatterParameters.FormatString:
                    ...
                    string expectedFormatString = Utility._xmlUtil.GetTextValue(nodeName,
            ...
            if (FormatterParameters.FormatString != formatParam)
            {
                ...
                for (int i = 0; i < expectedLeavesDistance.Length; i++)
                {
                    Assert.AreEqual(expectedLeavesDistance[i], leavesDistance[i].ToString());
                }
        ...
        static void GetAllNodesAndEdges(Node rootNode,
        ...
        static Tree GetFormattedObject(bool isSingleNode)
        {
