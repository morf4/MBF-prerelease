...
namespace MBF.TestAutomation.IO
{
    ...
    public class SnpP1TestCases
    {
        ...
        static void SnpParserGeneralTestCases(string nodename,
            AdditionalParameters additionalParam)
        {
            ...
            string noOfChromos = Utility._xmlUtil.GetTextValue(nodename,
            ...
            {
                string[] expectedPositions = Utility._xmlUtil.GetTextValues(nodename,
                ...
                string[] expectedSequenceIds = Utility._xmlUtil.GetTextValues(nodename,
                    Constants.SequenceIdsNode);

                // Validation of sequences with positions and xml is done in this section.
                for (int i = 0; i < int.Parse(noOfChromos); i++)
                {
                    ...
                    {
                        ISequenceItem item = tempSparseSeq[int.Parse(expectedChromoPositions[j])];
                        Assert.AreEqual(expectedChromoSequences[j], item.Symbol.ToString());
                    }
