    ...
    public class FastQBvtTestCases
    {
        ...
        public void FastQFormatterWithTextWriter()
        {
            ...
            FastQFormatType expectedFormatType = Utility.GetFastQFormatType(
                Utility._xmlUtil.GetTextValue(Constants.SimpleSangerFastQNode,
            ...
            Assert.AreEqual(seqsNew.Count.ToString(), expectedSeqCount);
        ...
        public void ValidateFastQParseOneWithSpecificFormatUsingFastQFile()
        {
            ...
            // Validate qualittative Sequence upon parsing FastQ file.
            Assert.AreEqual(qualSequence.Count.ToString(), expectedSeqCount);
            Assert.AreEqual(qualSequence.ToString(), expectedQualitativeSequence);
            Assert.AreEqual(qualSequence.ID.ToString(), expectedSequenceId);
        ...
        /// <param name="nodeName">xml node name.</param>
        /// </summary>
        static void ValidateFastQParseOne(string nodeName)
        {
            // Gets the expected sequence from the Xml
            string filePath = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.FilePathNode);
        ...
        /// </summary>
        static void ValidateFastQFormatter(string nodeName,
            FastQFileParameters fileExtension)
        {
            ...
            Assert.AreEqual(newQualSeq.ID.ToString(), expectedSequenceId);
        ...
        /// <param name="nodeName">xml node name.</param>
        /// </summary>
        static void ValidateFastQFormatString(string nodeName)
        {
            ...
            FastQFileParameters methodName)
        {
            ...
            // Validate qualittative Sequence upon parsing FastQ file.
            Assert.AreEqual(expectedSeqCount, newqualSequence.Count.ToString());
            ...
            Assert.AreEqual(newqualSequence[0].ID.ToString(), expectedSequenceId);
        ...
        /// <param name="methodName">Name of Method</param>
        /// </summary>
        static void ValidateDataVirtulization(string nodeName,
            FastQFileParameters methodName)
        {
            string filepathOriginal = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.FilePathNode);
            ...
            for (i = 0; i < count; i++)
            {
                originalIds += seqsOriginal[i].ID.ToString() + ",";
                newSeqIds += seqsNew[i].ID.ToString() + ",";
