...
namespace MBF.TestAutomation.IO.SAM
{
    ...
    public class SAMP2TestCases
    {
        ...
        /// </summary>
        [Test]
        public void InvalidateSAMISeqAlignParserReaderFlag()
        {
        ...
        /// </summary>
        [Test]
        public void InvalidateSAMISeqAlignParserFileNameFlag()
        {
        ...
        /// </summary>
        [Test]
        public void InvalidateSAMParserReaderFlag()
        {
        ...
        /// </summary>
        [Test]
        public void InvalidateSAMParserfileNameFlag()
        {
        ...
        /// </summary>
        [Test]
        public void InvalidateSAMParseOneReaderFlag()
        {
        ...
        /// </summary>
        [Test]
        public void InvalidateSAMParseOnefileNameFlag()
        {
        ...
        public void InvalidateSAMParseAlhabetProp()
        {
            try
            {
                new SAMParser().Alphabet = Alphabets.DNA;
                Assert.Fail();
            }
        ...
        /// <param name="method">enum type to execute different overload</param>
        /// </summary>
        void ValidateQualitySeqLength(ParseOrFormatQualLength method)
        {
