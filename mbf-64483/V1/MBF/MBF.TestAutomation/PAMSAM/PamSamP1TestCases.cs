...
namespace MBF.TestAutomation.PAMSAM
{
    ...
    public class PamSamP1TestCases
    {
        ...
        void InitializeStage1Variables(string nodeName)
        {
            ...
            stage1ExpectedScore = Utility._xmlUtil.GetTextValue(nodeName,
        ...
        void InitializeStage3Variables(string nodeName)
        {
            ...
            stage3ExpectedScore = Utility._xmlUtil.GetTextValue(nodeName,
        ...
        void AddOneLineSequences(string nodeName)
        {
            ...
            string sequenceString8 = Utility._xmlUtil.GetTextValue(nodeName, Constants.Sequence8);
            string sequenceString9 = Utility._xmlUtil.GetTextValue(nodeName, Constants.Sequence9);
            string sequenceString10 = Utility._xmlUtil.GetTextValue(nodeName, Constants.Sequence10);
            ...
            sequenceString10 = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequenceNode10);
            ...
            bool addOnelineSequences, bool IsAlignForMoreSeq)
        {
            ...
            Console.WriteLine("Alignment Score is {0}", msa.AlignmentScore.ToString());
            ...
            int gpOpenPenalty, int gpExtendPenalty, bool IsAlignedLargeSeq)
        {
            ...
            Console.WriteLine("Expected Score :{0}", msa.AlignmentScore.ToString());
            Assert.IsTrue(expectedScore.Contains(msa.AlignmentScore.ToString()));
            Console.WriteLine(String.Format(
            ...
            bool IsAlignStage1)
        {
            ...
            Console.WriteLine("Stage1 Score:{0}", msa.AlignmentScoreA.ToString());
            Assert.IsTrue(stage1ExpectedScore.Contains(
                msa.AlignmentScoreA.ToString()));
            ...
            bool IsStageAlignment)
        {
            ...
            Console.WriteLine("Score{0}\n", msa.AlignmentScoreC.ToString());
            Assert.IsTrue(stage3ExpectedScore.Contains(msa.AlignmentScoreC.ToString()));
        ...
        void ValidateDistanceMatrix(string nodeName, IDistanceMatrix matrix)
        {
            ...
            string expectedMinimumValue = Utility._xmlUtil.GetTextValue(nodeName,
            ...
            Assert.AreEqual(expectedMinimumValue, matrix.MinimumValue.ToString());
            ...
            List<BinaryGuideTreeEdge> edges)
        {
            ...
            string expectedEdgeCount = Utility._xmlUtil.GetTextValue(nodeName, Constants.EdgesCount);
            ...
            string expectednode = Utility._xmlUtil.GetTextValue(nodeName, Constants.Nodes);
        ...
        void ValidateBinaryTree(BinaryGuideTree binaryTree, string nodeName)
        {
            ...
            Assert.AreEqual(rootId, binaryTree.Root.ID.ToString());
            Assert.AreEqual(leavesCount, binaryTree.NumberOfLeaves.ToString());
            int index = 0;
            foreach (BinaryGuideTreeNode node in binaryTree.Nodes)
            {
                ...
                {
                    Console.WriteLine("Nodes:{0}", node.LeftChildren.ID.ToString());
                    Assert.IsTrue(expectedNodesLeftChild.Contains(node.LeftChildren.ID.ToString()));
                }
            ...
            MoleculeType moleculeType)
        {
            ...
            Assert.AreEqual(node.ID.ToString(), expectednode);
            Assert.AreEqual(node.LeftChildren.ID.ToString(), expectedNodesLeftChild);
            Assert.AreEqual(node.RightChildren.ID.ToString(), expectedNodesRightChild);
        ...
        void ValidateBinaryTreeCompareTrees(string nodeName, int kmrLength, MoleculeType moleculeType)
        {
            ...
            foreach (BinaryGuideTreeNode node in stage1BinaryTree.Nodes)
            {
                ...
                {
                    Assert.AreEqual(node.ID.ToString(), expectedNodes[index]);
                }
                index++;
            }
        ...
        void ValidateProfileAlignerGenerateEString(string nodeName, MoleculeType moleculeType, int edgeIndex)
        {
            ...
            {
                //Assert.IsTrue(expectedTreeEdges.Contains(eStringSubtreeEdge[index].ToString()));
                Console.WriteLine("eStringEdges : {0}\n", eStringSubtreeEdge[index].ToString());
                Assert.IsTrue(expectedTreeEdges.Contains(eStringSubtreeEdge[index].ToString()));
            }

            Assert.IsTrue(expectedTreeRoot.Contains(eStringSubtreeRoot[0].ToString()));
        ...
        void ValidateProfileExtraction(string nodeName, MoleculeType moleculeType, int edgeIndex)
        {
            ...
            string expectedProfileCount = Utility._xmlUtil.GetTextValue(nodeName, Constants.ProfileMatrix);

            Assert.AreEqual(expectedColSize, separatedProfileAlignments[0].ProfilesMatrix.ColumnSize.ToString());
            Assert.IsTrue(expectedProfileCount.Contains(separatedProfileAlignments[0].ProfilesMatrix.ProfilesMatrix.Count.ToString()));
        ...
        void ValidateGenerateProfileAlignmentWithSequences(string nodeName, MoleculeType moleculeType)
        {
            ...
            Assert.AreEqual(profile.ProfilesMatrix.ColumnSize.ToString(), expectedColSize);
            Assert.AreEqual(profile.ProfilesMatrix.RowSize.ToString(), expectedRowSize);
            ...
            int degreeOfParallelism, int edgeIndex, AlignType overloadType)
        {
            ...
            else
            {
                ...
                {
                    Console.WriteLine(
                        String.Format(@"PamsamP1Test: NeedlemanWunschProfileAlignerParallel could not be instantiated
            ...
            if (null != alignedProfile)
            {
                ...
                Console.WriteLine(
                    String.Format(@"PamsamP1Test: {0} {1} method validation completed successfully with
            ...
            ProfileScoreFunctionNames profileFunction, int edgeIndex, MoleculeType moleculeType)
        {
            ...
            Console.WriteLine(
                String.Format(@"PamsamP1Test: {0} Align() method validation completed successfully with
        ...
        void ValidateAlignmentScore(string nodeName, MoleculeType type, ScoreType scoreType)
        {
            ...
            switch (scoreType)
            {
                case ScoreType.QScore:
                    ...
                    Console.WriteLine("Q Score :{0}", qScore.ToString());
                    Assert.IsTrue(expectedQScore.Contains(qScore.ToString()));
                    break;
                case ScoreType.TCScore:
                    string expectedTCScore = Utility._xmlUtil.GetTextValue(nodeName,
                        Constants.TCScoreNode);
                    float tcScore = MsaUtils.CalculateAlignmentScoreQ(alignedSequences, refSequences);
                    Console.WriteLine("T Score :{0}", tcScore.ToString());
                    Assert.IsTrue(expectedTCScore.Contains(tcScore.ToString()));
                    break;
                case ScoreType.Offset:
                    ...
                    Console.WriteLine("residuesCount :{0}", residuesCount.ToString());
                    Assert.IsTrue(expectedResiduesCount.Contains(residuesCount.ToString()));
                    break;
                ...
                case ScoreType.PairWiseScoreFunction:
                    ...
                    Console.WriteLine("pairwiseScore :{0}", pairwiseScore.ToString());
                    Assert.IsTrue(expectedPairwiseScore.Contains(pairwiseScore.ToString()));
                    break;
            }

            Console.WriteLine(
                String.Format(@"PamsamP1Test:{0} validation completed successfully for molecule type {1}",
                scoreType.ToString(),
                type));
            ApplicationLog.WriteLine(
                String.Format(@"PamsamP1Test:{0} validation completed successfully for molecule type {1}",
        ...
        void ValidateUNAlign(string nodeName, MoleculeType type)
        {
            ...
            Console.WriteLine(
                String.Format(@"PamsamP1Test:Validation of UnAlign() method of MsaUtils completed 
            ...
            MoleculeType moleculeType, int edgeIndex, FunctionType functionType)
        {
            ...
            switch (functionType)
            {
                case FunctionType.Correlation:
                    ...
                    Console.WriteLine("Coorelation:{0}", correlation.ToString());
                    Assert.IsTrue(expectedCorrelation.Contains(correlation.ToString()));
                    break;
                case FunctionType.FindMaxIndex:
                    ...
                    int index = MsaUtils.FindMaxIndex(
                        separatedProfileAlignments[0].ProfilesMatrix.ProfilesMatrix[0]);
                    Console.WriteLine("Index:{0}", index.ToString());
                ...
                case FunctionType.JensenShanonDivergence:
                    ...
                    float jsdivergence = MsaUtils.JensenShannonDivergence(
                        separatedProfileAlignments[0].ProfilesMatrix.ProfilesMatrix[0],
                        separatedProfileAlignments[1].ProfilesMatrix.ProfilesMatrix[0]);
                    Console.WriteLine("jsdivergence:{0}", jsdivergence.ToString());
                    Assert.IsTrue(expectedJsDivergence.Contains(jsdivergence.ToString()));
                    break;
                case FunctionType.KullbackLeiblerDistance:
                    ...
                    float kldistance = MsaUtils.KullbackLeiblerDistance(
                        separatedProfileAlignments[0].ProfilesMatrix.ProfilesMatrix[0],
                        separatedProfileAlignments[1].ProfilesMatrix.ProfilesMatrix[0]);
                    Console.WriteLine("kldistance:{0}", kldistance.ToString());
                    Assert.AreEqual(expectedKlDistance, kldistance.ToString());
                    break;
            }

            Console.WriteLine(String.Format(@"Validation of {0} function calculation of MsaUtils completed 
                                            successfully for molecule type {1}",
                                         functionType,
                                         moleculeType));
            ApplicationLog.WriteLine(String.Format(@"Validation of {0} function calculation of MsaUtils completed 
                                            successfully for molecule type {1}",
                                            functionType,
                                            moleculeType));
        }
