...
namespace MBF.TestAutomation
{
    ...
    public class DerivedSequenceP1TestCases
    {
        ...
        public void ValidateDerivedSequenceGetObjectData()
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(Constants.RnaDerivedSequenceNode,
                Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(Constants.RnaDerivedSequenceNode,
        ...
        public void ValidateDerivedSequenceAllProperties()
        {
            ...
            Stream stream = File.Open("DerivedSequence.data", FileMode.Create);
        ...
        {
            // Get input and expected values from xml
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string removeRange = Utility._xmlUtil.GetTextValue(nodeName, Constants.RemoveRange);
            string addSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddSequence);
            string derivedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.DerivedSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceGetUpdatedItems(string nodeName)
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string removePosition = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.UpdatedItemRemovePosition);
            string insertParams = Utility._xmlUtil.GetTextValue(nodeName, Constants.UpdatedItemInsertParams);
            string derivedSequence = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.RemoveInsertDerivedSequence);
            string updatedItems = Utility._xmlUtil.GetTextValue(nodeName, Constants.UpdatedItemList);
            string updatedIndices = Utility._xmlUtil.GetTextValue(nodeName, Constants.UpdatedItemsIndex);
            string updatedTypes = Utility._xmlUtil.GetTextValue(nodeName, Constants.UpdatedTypeList);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceClearWithInsertRemove(string nodeName)
        {
            ...
            string removePosition = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.UpdatedItemRemovePosition);
            string insertParams = Utility._xmlUtil.GetTextValue(nodeName, Constants.UpdatedItemInsertParams);
            string removeInsertDerivedSequence = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.RemoveInsertDerivedSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceIndexOf(string nodeName)
        {
            ...
            string addSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddSequence);
            string derivedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.DerivedSequence);
            string indexOfSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.IndexOfSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceRemoveAt(string nodeName)
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string removeRange = Utility._xmlUtil.GetTextValue(nodeName, Constants.RemoveRange1);
            string derivedSequence = Utility._xmlUtil.GetTextValue(
        ...
        private void ValidateDerivedSequenceRemove(string nodeName)
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string removeSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.RangeSequence);
            string derivedSequence = Utility._xmlUtil.GetTextValue(
                nodeName, Constants.RemoveDerivedSequence1);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceAdd(string nodeName)
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string derivedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddDerivedSequence);
            string addSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceInsertWithChar(string nodeName)
        {
            ...
            string insertSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceInsertRange(string nodeName)
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string derivedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.InsertSequence);
            string insertSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void ValidateDerivedSequenceRange(string nodeName)
        {
            ...
            string removeRange = Utility._xmlUtil.GetTextValue(nodeName, Constants.RemoveRange);
            string addSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.AddSequence);
            string rangeSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.RangeSequence);
        ...
        private void ValidateDerivedSequenceReplaceRange(string nodeName)
        {
            ...
            string expectedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ExpectedSequence);
            string alphabetName = Utility._xmlUtil.GetTextValue(nodeName, Constants.AlphabetNameNode);
            string derivedSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ReplaceSequence);
            string replaceSequence = Utility._xmlUtil.GetTextValue(nodeName, Constants.ReplaceRangeSequence);
            IAlphabet alphabet = Utility.GetAlphabet(alphabetName);
        ...
        private void CreateDerivedSequenceWithRemoveInsert(ref DerivedSequence derSequence,
        ...
        private DerivedSequence CreateDerivedSequenceWithAddRemove(IAlphabet alphabet,
