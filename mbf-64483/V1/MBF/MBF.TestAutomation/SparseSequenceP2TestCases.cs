...
namespace MBF.TestAutomation
{
    ...
    public class SparseSequenceP2TestCases
    {
        ...
        /// <summary>
        ///  Validate ToString() method in sparse sequence class.
        /// Input Data : Valid Dna Alphabet,sequence count.
        /// Output Data : Validation of an exception.
        /// </summary>
        [Test]
        public void ValidateSparseSequenceToString()
        {
            ...
            // Try to convert Sparse sequence to ToString().
            try
            {
                sparseSeq.ToString();
            }
        ...
        /// <returns></returns>
        SparseSequence CreateSparseSequence(IAlphabet alphabet, int insertPosition)
        {
