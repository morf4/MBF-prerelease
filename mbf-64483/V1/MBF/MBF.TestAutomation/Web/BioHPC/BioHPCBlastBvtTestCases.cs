...
namespace MBF.TestAutomation.Web.BioHPCBlast
{
    ...
    public class BioHPCBlastBvtTestCases
    {
        ...
        static BioHPCBlastBvtTestCases()
        {
            ...
            Utility._xmlUtil =
                new XmlUtility(@"TestUtils\BioHPCTestConfigs.xml");
        ...
        public void ValidateAsyncDnaResultsFetch()
        {
            ValidateBioHPCBlastResultsFetch(
                Constants.BioHPCAsynchronousResultsForDnaNode, false);
        }
        ...
        {
            ValidateBioHPCBlastResultsFetch(
                Constants.BioHPCAsynchronousResultsForDnaNode, true);
        }
        ...
        {
            ValidateBioHPCBlastResultsFetch(
                Constants.BioHPCAsynchronousResultsForProteinNode, false);
        }
        ...
        {
            ValidateBioHPCBlastResultsFetch(
                Constants.BioHPCAsynchronousResultsForProteinNode, true);
        }
        ...
        public void ValidateBioHPCBlastWebServiceProperties()
        {
            ...
            BioHPCBlastHandler service = new BioHPCBlastHandler(configParams);
        ...
        /// </summary>
        static void ValidateBioHPCGeneralGetRequestStatusMethod(string nodeName)
        {
            if (_IsWebServiceAvailable)
            {
                // Gets the search query parameter and their values.
        ...
        /// <param name="nodeName">different alphabet node name</param>
        /// </summary>
        static void ValidateCancelSubmittedJob(
            string nodeName,
            RequestType type)
        {
            if (_IsWebServiceAvailable)
        ...
        static bool ValidateWebServiceConnection()
        {
            try
            {
                if (!string.IsNullOrEmpty(new BioHPCWebService().HelloWorld()))
                {
                    Console.WriteLine("BioHPC Blast BVT : Connection Successful");
                    return true;
                }
                else
                {
                    Console.WriteLine(
                        "BioHPC Blast Bvt : Connection not successful due to error");
                    ApplicationLog.WriteLine(
                        "BioHPC Blast Bvt : Connection not successful due to error");
                    return false;
                }
