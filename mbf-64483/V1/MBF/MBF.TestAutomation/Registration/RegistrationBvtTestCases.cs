...
namespace MBF.TestAutomation.Registration
{
    ...
    public class RegistrationBvtTestCases
    {
        ...
        public void RegisterAddinsRegisterAssembly()
        {
            ...
            if (null != registeredAssemblers && registeredAssemblers.Count > 0)
            {
                foreach (IDeNovoAssembler assembler in finalValue)
                {
                    ...
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Assembly '{0}'.",
                        name));
        ...
        public void RegisterAddinsRegisterAlphabet()
        {
            ...
            if (null != registeredAlphabets && registeredAlphabets.Count > 0)
            {
                foreach (IAlphabet alphabet in finalValue)
                {
                    ...
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Alphabet '{0}'.",
                        name));
                    ApplicationLog.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Alphabet '{0}'.",
                        name));
        ...
        public void RegisterAddinsRegisterFormatter()
        {
            ...
            if (null != registeredFormatters && registeredFormatters.Count > 0)
            {
                foreach (ISequenceFormatter formatter in finalValue)
                {
                    ...
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Formatter '{0}'.",
                        name));
                    ApplicationLog.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Formatter '{0}'.",
                        name));
        ...
        public void RegisterAddinsRegisterParser()
        {
            ...
            if (null != registeredParsers && registeredParsers.Count > 0)
            {
                foreach (ISequenceParser parser in finalValue)
                {
                    ...
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Parser '{0}'.",
                        name));
                    ApplicationLog.WriteLine(
                        string.Format(@"Successfully validated the Registered components for Parser '{0}'.",
                        name));
        ...
        public void RegisterAddinsRegisterAlignmentFormatter()
        {
            ...
            if (null != registeredFormatters && registeredFormatters.Count > 0)
            {
                foreach (ISequenceAlignmentFormatter formatter in finalValue)
                {
                    ...
                    Assert.AreEqual(formatter.Description, description);
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered components for AlignmentFormatter '{0}'.",
                        name));
                    ApplicationLog.WriteLine(
                        string.Format(@"Successfully validated the Registered components for AlignmentFormatter '{0}'.",
                        name));
        ...
        public void RegisterAddinsRegisterAlignmentParser()
        {
            ...
            if (null != registeredParsers && registeredParsers.Count > 0)
            {
                foreach (ISequenceAlignmentParser parser in finalValue)
                {
                    ...
                    Assert.AreEqual(parser.Description, description);
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered components for AlignmentParser '{0}'.",
                        name));
                    ApplicationLog.WriteLine(
                        string.Format(@"Successfully validated the Registered components for AlignmentParser '{0}'.",
                        name));
        ...
        public void RegisterAddinsAllProperties()
        {
            ...
            Console.WriteLine(
                string.Format("Successfully validate the property AddInFolderPath with value '{0}'",
        ...
        public class TestAutomationSequenceAligner : ISequenceAligner
        {
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationPairwiseSequenceAligner : IPairwiseSequenceAligner
        {
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationSequenceAssembler : IDeNovoAssembler
        {
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationAlphabet : IAlphabet
        {
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationSequenceFormatter : ISequenceFormatter
        {
            ...
            /// <returns></returns>
            public string Format(ISequence sequence)
            {
                throw new System.NotImplementedException();
            }
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationSequenceParser : ISequenceParser
        {
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationSequenceAlignmentFormatter : ISequenceAlignmentFormatter
        {
        ...
        /// </summary>
        [RegistrableAttribute(true)]
        public class TestAutomationSequenceAlignmentParser : ISequenceAlignmentParser
        {
            ...
            IList<ISequenceAligner> finalValue)
        {
            if (null != registeredAligners && registeredAligners.Count > 0)
            {
                foreach (ISequenceAligner aligner in finalValue)
                {
                    ...
                    Console.WriteLine(
                        string.Format(@"Successfully validated the Registered Instances for '{0}'.",
                        name));
                    ApplicationLog.WriteLine(
                        string.Format(@"Successfully validated the Registered Instances for '{0}'.",
                        name));
