            ...
            if (sequence.Metadata.ContainsKey(_featuresKey))
            {
                    ...
                    sequence.Metadata[_featuresKey] as List<MetadataListItem<List<string>>>)
                {
                        ...
                        feature.SubItems.ContainsKey(_endKey))
                    {
                        ...
                        featureLine += GetSubItemString(feature, _sourceKey);
                        featureLine += "\t" + feature.Key;
                        featureLine += GetSubItemString(feature, _startKey);
                        featureLine += GetSubItemString(feature, _endKey);
                        featureLine += GetSubItemString(feature, _scoreKey);
                        featureLine += GetSubItemString(feature, _strandKey);
                        featureLine += GetSubItemString(feature, _frameKey);
